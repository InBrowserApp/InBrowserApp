...
import { routes as sha3_224HashTextOrFileRoutes } from '@tools/sha3-224-hash-text-or-file/routes'
import { routes as sha3_256HashTextOrFileRoutes } from '@tools/sha3-256-hash-text-or-file/routes'
import { routes as sha3_384HashTextOrFileRoutes } from '@tools/sha3-384-hash-text-or-file/routes'
...
import { routes as sha512_224HashTextOrFileRoutes } from '@tools/sha512-224-hash-text-or-file/routes'
import { routes as sha512_256HashTextOrFileRoutes } from '@tools/sha512-256-hash-text-or-file/routes'
import { routes as sha1HashTextOrFileRoutes } from '@tools/sha1-hash-text-or-file/routes'
import { routes as md4HashTextOrFileRoutes } from '@tools/md4-hash-text-or-file/routes'
import { routes as adler32HashTextOrFileRoutes } from '@tools/adler32-hash-text-or-file/routes'
...
import { routes as base85EncoderRoutes } from '@tools/base85-encoder/routes'
import { routes as base85DecoderRoutes } from '@tools/base85-decoder/routes'
...
import { routes as sqlFormatterAndLinterRoutes } from '@tools/sql-formatter-and-linter/routes'
...
import { routes as cameraRoutes } from '@tools/camera/routes'
...
import { routes as robotsTxtTesterRoutes } from '@tools/robots-txt-tester/routes'
...
export const routes: ToolRoute[] = [
  ...
  ...sha3_224HashTextOrFileRoutes,
  ...sha3_256HashTextOrFileRoutes,
  ...sha3_384HashTextOrFileRoutes,
  ...
  ...sha512_224HashTextOrFileRoutes,
  ...sha512_256HashTextOrFileRoutes,
  ...sha1HashTextOrFileRoutes,
  ...md4HashTextOrFileRoutes,
  ...adler32HashTextOrFileRoutes,
