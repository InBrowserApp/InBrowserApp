  ...
  return (
    <article
      className={cn(
        ...
        "[&_h2]:mt-8 [&_h2]:scroll-m-20 [&_h2]:font-heading [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:tracking-tight [&_h2]:text-balance [&_h2]:text-foreground sm:[&_h2]:text-xl",
        "[&_h2:first-child]:mt-0",
        "[&_h3]:mt-8 [&_h3]:scroll-m-20 [&_h3]:font-heading [&_h3]:text-base [&_h3]:font-semibold [&_h3]:tracking-tight [&_h3]:text-foreground sm:[&_h3]:text-2xl",
        "[&_h4]:mt-6 [&_h4]:scroll-m-20 [&_h4]:font-heading [&_h4]:text-base [&_h4]:font-semibold [&_h4]:tracking-tight [&_h4]:text-foreground sm:[&_h4]:text-xl",
        ...
        "[&_code]:relative [&_code]:rounded [&_code]:bg-muted [&_code]:px-[0.3rem] [&_code]:py-[0.2rem] [&_code]:font-mono [&_code]:text-sm [&_code]:font-semibold [&_code]:text-foreground",
