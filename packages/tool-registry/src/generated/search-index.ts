...
export const toolSearchIndex: readonly ToolSearchIndexEntry[] = [
  ...
  },
  {
    ...
    category: "web",
    icon: "globe",
    tags: ["favicon", "icon", "pwa", "manifest", "image"],
    locales: {
      ar: {
        name: "مولد موارد أيقونة الموقع",
        description:
          "إنشاء موارد أيقونة الموقع لموقعك الإلكتروني بأحجام وتنسيقات مختلفة",
      },
      de: {
      ...
      en: {
        ...
        description:
          "Generate favicon assets for your website with various sizes and formats",
      },
      es: {
        name: "Generador de Recursos de Favicon",
        description:
          "Genera recursos de favicon para su sitio web en varios tamaños y formatos",
      },
      fr: {
      ...
      he: {
        ...
        description:
          "צור משאבי פאביקון עבור אתר האינטרנט שלך במגוון גדלים ופורמטים",
      },
      hi: {
        name: "फेविकॉन संसाधन जनरेटर",
        description:
          "विभिन्न आकारों और प्रारूपों में अपनी वेबसाइट के लिए फेविकॉन संसाधन उत्पन्न करें",
      },
      id: {
        name: "Pembuat Aset Favicon",
        description:
          "Buat aset favicon untuk situs web Anda dalam berbagai ukuran dan format",
      },
      it: {
        name: "Generatore di Risorse Favicon",
        description:
          "Genera risorse favicon per il tuo sito web in varie dimensioni e formati",
      },
      ja: {
        name: "ファビコンアセット生成器",
        description:
          "様々なサイズとフォーマットでウェブサイト用のファビコンアセットを生成",
      },
      ko: {
        name: "파비콘 자산 생성기",
      ...
      ms: {
        ...
        description:
          "Jana aset favicon untuk laman web anda dalam pelbagai saiz dan format",
      },
      nl: {
      ...
      no: {
        ...
        description:
          "Generer favicon-ressurser for nettstedet ditt i ulike størrelser og formater",
      },
      pl: {
      ...
      pt: {
        ...
        description:
          "Gere recursos de favicon para seu site em vários tamanhos e formatos",
      },
      ru: {
        name: "Генератор Ресурсов Favicon",
        description:
          "Создавайте ресурсы favicon для вашего веб-сайта различных размеров и форматов",
      },
      sv: {
        name: "Favicon Resursgenerator",
        description:
          "Generera favicon-resurser för din webbplats i olika storlekar och format",
      },
      th: {
      ...
      tr: {
        ...
        description:
          "Web siteniz için çeşitli boyutlarda ve formatlarda favicon varlıkları oluşturun",
      },
      vi: {
