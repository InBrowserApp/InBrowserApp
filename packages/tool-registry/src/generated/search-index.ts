...
export const toolSearchIndex: readonly ToolSearchIndexEntry[] = [
  ...
  },
  {
    ...
    locales: {
      ar: {
        name: "تجزئة MurmurHash3 (x64 128-bit) للنص أو الملف",
        description:
          "أنشئ تجزئات MurmurHash3 x64 128-bit لإدخال النص أو رفع الملفات. احسب مجاميع تحقق سريعة غير تشفيرية للتقسيم إلى حاويات، وإزالة التكرار، ومفاتيح التخزين المؤقت، وفحوصات السلامة.",
      },
      de: {
        name: "MurmurHash3 (x64 128-bit)-Hash für Text oder Datei",
        description:
          "Generieren Sie MurmurHash3 x64 128-bit-Hashes für Texteingaben oder Datei-Uploads. Berechnen Sie schnelle nicht-kryptografische Prüfsummen für Bucketing, Deduplizierung, Cache-Schlüssel und Integritätsprüfungen.",
      },
      en: {
        name: "MurmurHash3 (x64 128-bit) Hash Text or File",
        description:
      ...
      es: {
        name: "Hash MurmurHash3 (x64 de 128 bits) de texto o archivo",
        description:
          "Genera hashes MurmurHash3 x64 de 128 bits para entradas de texto o archivos cargados. Calcula sumas de comprobación no criptográficas rápidas para agrupación, deduplicación, claves de caché y comprobaciones de integridad.",
      },
      fr: {
        name: "Hachage MurmurHash3 (x64 128 bits) de texte ou fichier",
        description:
          "Générez des hachages MurmurHash3 x64 128 bits pour une saisie de texte ou des fichiers importés. Calculez rapidement des sommes de contrôle non cryptographiques pour la répartition en compartiments, la déduplication, les clés de cache et les contrôles d'intégrité.",
      },
      he: {
        name: "גיבוב טקסט או קובץ באמצעות MurmurHash3 (x64 128-bit)",
        description:
          "צרו ערכי גיבוב MurmurHash3 x64 באורך 128 ביט עבור קלט טקסט או קבצים שהועלו. חשבו סכומי בדיקה לא-קריפטוגרפיים מהירים לחלוקה לדליים, הסרת כפילויות, מפתחות מטמון ובדיקות תקינות.",
      },
      hi: {
        name: "MurmurHash3 (x64 128-bit) टेक्स्ट या फ़ाइल हैश करें",
        description:
          "टेक्स्ट इनपुट या फ़ाइल अपलोड के लिए MurmurHash3 x64 128-bit हैश जनरेट करें। बकेटिंग, डुप्लिकेशन हटाने, कैश कुंजियों और अखंडता जांचों के लिए तेज़ गैर-क्रिप्टोग्राफिक चेकसम की गणना करें।",
      },
      id: {
        name: "Hash MurmurHash3 (x64 128-bit) Teks atau File",
        description:
          "Buat hash MurmurHash3 x64 128-bit untuk input teks atau unggahan file. Hitung checksum non-kriptografi cepat untuk pengelompokan bucket, deduplikasi, kunci cache, dan pemeriksaan integritas.",
      },
      it: {
        name: "Hash MurmurHash3 (x64 128-bit) di testo o file",
        description:
          "Genera hash MurmurHash3 x64 a 128 bit per input di testo o caricamenti di file. Calcola checksum non crittografici veloci per bucketing, deduplicazione, chiavi di cache e controlli di integrità.",
      },
      ja: {
        name: "MurmurHash3 (x64 128-bit) テキストまたはファイルのハッシュ生成",
        description:
          "テキスト入力またはファイルアップロードから MurmurHash3 x64 128-bit ハッシュを生成します。バケット分け、重複排除、キャッシュキー、整合性チェック向けの高速な非暗号学的チェックサムを計算します。",
      },
      ko: {
        name: "MurmurHash3 (x64 128-bit) 텍스트 또는 파일 해시",
        description:
          "텍스트 입력 또는 파일 업로드의 MurmurHash3 x64 128-bit 해시를 생성합니다. 버킷팅, 중복 제거, 캐시 키, 무결성 검사를 위한 빠른 비암호화 체크섬을 계산하세요.",
      },
      ms: {
        name: "Hash MurmurHash3 (x64 128-bit) Teks atau Fail",
        description:
          "Jana hash MurmurHash3 x64 128-bit untuk input teks atau muat naik fail. Kira checksum bukan kriptografi yang pantas untuk pengelompokan, penyahgandaan, kunci cache, dan semakan integriti.",
      },
      nl: {
        name: "MurmurHash3 (x64 128-bit)-hash van tekst of bestand",
        description:
          "Genereer MurmurHash3 x64 128-bit-hashes voor tekstinvoer of bestandsuploads. Bereken snelle, niet-cryptografische checksums voor bucketing, deduplicatie, cachesleutels en integriteitscontroles.",
      },
      no: {
        name: "MurmurHash3 (x64 128-bit): hash tekst eller fil",
        description:
          "Generer MurmurHash3 x64 128-bit-hasher for tekstinndata eller filopplastinger. Beregn raske ikke-kryptografiske sjekksummer for bucket-inndeling, deduplisering, cache-nøkler og integritetssjekker.",
      },
      pl: {
        name: "Hash MurmurHash3 (x64 128-bit) tekstu lub pliku",
        description:
          "Generuj hashe MurmurHash3 x64 128-bit dla tekstu lub przesyłanych plików. Obliczaj szybkie, niekryptograficzne sumy kontrolne do przypisywania do bucketów, deduplikacji, kluczy cache i sprawdzania integralności.",
      },
      pt: {
        name: "Hash MurmurHash3 (x64 128-bit) de Texto ou Arquivo",
        description:
          "Gere hashes MurmurHash3 x64 de 128 bits para entrada de texto ou uploads de arquivos. Calcule somas de verificação não criptográficas rápidas para distribuição em buckets, deduplicação, chaves de cache e verificações de integridade.",
      },
      ru: {
        name: "MurmurHash3 (x64 128-bit)-хеш текста или файла",
        description:
          "Генерируйте 128-битные хеши MurmurHash3 x64 для текстового ввода или загружаемых файлов. Вычисляйте быстрые некриптографические контрольные суммы для распределения по бакетам, дедупликации, ключей кеша и проверок целостности.",
      },
      sv: {
        name: "MurmurHash3 (x64 128-bit): hasha text eller fil",
        description:
          "Generera MurmurHash3 x64 128-bitars hashvärden för textinmatning eller filuppladdningar. Beräkna snabba icke-kryptografiska kontrollsummor för bucketindelning, deduplicering, cachenycklar och integritetskontroller.",
      },
      th: {
        name: "แฮชข้อความหรือไฟล์ด้วย MurmurHash3 (x64 128-bit)",
        description:
          "สร้างแฮช MurmurHash3 x64 128-bit สำหรับข้อความที่ป้อนหรือไฟล์ที่อัปโหลด คำนวณเช็คซัมแบบไม่ใช่การเข้ารหัสที่รวดเร็วสำหรับการแบ่งกลุ่ม การลบรายการซ้ำ คีย์แคช และการตรวจสอบความสมบูรณ์ของข้อมูล",
      },
      tr: {
        name: "MurmurHash3 (x64 128-bit) Metin veya Dosya Hash'i",
        description:
          "Metin girişi veya dosya yüklemeleri için MurmurHash3 x64 128-bit hash'leri oluşturun. Gruplama, tekilleştirme, önbellek anahtarları ve bütünlük kontrolleri için hızlı, kriptografik olmayan sağlama toplamları hesaplayın.",
      },
      vi: {
        name: "Băm văn bản hoặc tệp bằng MurmurHash3 (x64 128-bit)",
        description:
          "Tạo giá trị băm MurmurHash3 x64 128-bit cho đầu vào văn bản hoặc tệp tải lên. Tính checksum phi mật mã nhanh cho việc phân nhóm, khử trùng lặp, khóa cache và kiểm tra tính toàn vẹn.",
      },
      "zh-CN": {
        name: "MurmurHash3 (x64 128-bit) 哈希文本或文件",
        description:
          "为文本输入或文件上传生成 MurmurHash3 x64 128-bit 哈希值。计算快速的非加密校验和，用于分桶、去重、缓存键和完整性检查。",
      },
      "zh-TW": {
  ...
  },
  {
    ...
    locales: {
      ar: {
        name: "حساب تجزئة SipHash-128-2-4 للنص أو الملف",
        description:
          "ولّد تجزئات مفتاحية باستخدام SipHash-128-2-4 لإدخال نصي أو ملف مرفوع. استخدم مفتاحا سداسيا عشريا بطول 128 بت لحساب تجزئات غير تعمية سريعة بطول 128 بت لعمليات جداول التجزئة ومفاتيح التخزين المؤقت والمجاميع الاختبارية.",
      },
      de: {
        name: "SipHash-128-2-4-Hash für Text oder Datei",
        description:
          "Erzeuge schlüsselbasierte SipHash-128-2-4-Hashes für Texteingaben oder Datei-Uploads. Verwende einen 128-Bit-Hex-Schlüssel, um schnelle, nicht kryptografische 128-Bit-Hashes für Hash-Tabellen, Cache-Schlüssel und Prüfsummen-Workflows zu berechnen.",
      },
      en: {
      ...
      es: {
        name: "Hash SipHash-128-2-4 para texto o archivo",
        description:
          "Genera hashes con clave SipHash-128-2-4 para entradas de texto o archivos subidos. Usa una clave hexadecimal de 128 bits para calcular hashes no criptográficos rápidos de 128 bits en flujos de trabajo de tablas hash, claves de caché y sumas de comprobación.",
      },
      fr: {
        name: "Hacher du texte ou un fichier avec SipHash-128-2-4",
        description:
          "Générez des hachages à clé SipHash-128-2-4 pour une saisie de texte ou un téléversement de fichier. Utilisez une clé hexadécimale de 128 bits pour calculer rapidement des hachages non cryptographiques de 128 bits pour les tables de hachage, les clés de cache et les sommes de contrôle.",
      },
      he: {
        name: "גיבוב טקסט או קובץ עם SipHash-128-2-4",
        description:
          "צרו ערכי גיבוב SipHash-128-2-4 עם מפתח עבור קלט טקסט או העלאת קובץ. השתמשו במפתח הקסדצימלי של 128 ביט כדי לחשב במהירות ערכי גיבוב לא קריפטוגרפיים באורך 128 ביט עבור תהליכי עבודה של טבלאות גיבוב, מפתחות מטמון וסכומי ביקורת.",
      },
      hi: {
        name: "SipHash-128-2-4 टेक्स्ट या फ़ाइल हैश करें",
        description:
          "टेक्स्ट इनपुट या फ़ाइल अपलोड के लिए SipHash-128-2-4 कुंजी-आधारित हैश जेनरेट करें। हैश-टेबल, कैश-कुंजी, और चेकसम वर्कफ़्लो के लिए तेज़ 128-बिट गैर-क्रिप्टोग्राफ़िक हैश की गणना करने हेतु 128-बिट हेक्स कुंजी का उपयोग करें।",
      },
      id: {
        name: "Hash Teks atau File SipHash-128-2-4",
        description:
          "Buat hash berkunci SipHash-128-2-4 untuk input teks atau unggahan file. Gunakan kunci heksadesimal 128-bit untuk menghitung hash non-kriptografis 128-bit yang cepat untuk alur kerja tabel hash, kunci cache, dan checksum.",
      },
      it: {
        name: "Hash SipHash-128-2-4 per testo o file",
        description:
          "Genera hash con chiave SipHash-128-2-4 per input di testo o caricamenti di file. Usa una chiave esadecimale a 128 bit per calcolare hash non crittografici rapidi a 128 bit per flussi di lavoro con tabelle hash, chiavi cache e checksum.",
      },
      ja: {
        name: "SipHash-128-2-4 でテキストまたはファイルをハッシュ化",
        description:
          "テキスト入力またはファイルアップロードから SipHash-128-2-4 のキー付きハッシュを生成します。128 ビットの 16 進キーを使用して、ハッシュテーブル、キャッシュキー、チェックサムのワークフロー向けに高速な 128 ビットの非暗号学的ハッシュを計算します。",
      },
      ko: {
        name: "SipHash-128-2-4 텍스트 또는 파일 해시",
        description:
          "텍스트 입력 또는 파일 업로드용 SipHash-128-2-4 키 기반 해시를 생성합니다. 128비트 16진수 키를 사용해 해시 테이블, 캐시 키, 체크섬 워크플로에 필요한 빠른 128비트 비암호학적 해시를 계산하세요.",
      },
      ms: {
        name: "Hash Teks atau Fail dengan SipHash-128-2-4",
        description:
          "Jana hash berkunci SipHash-128-2-4 untuk input teks atau muat naik fail. Gunakan kunci heksadesimal 128-bit untuk mengira hash 128-bit bukan kriptografik yang pantas bagi aliran kerja jadual hash, kunci cache, dan checksum.",
      },
      nl: {
        name: "SipHash-128-2-4-hash voor tekst of bestand",
        description:
          "Genereer SipHash-128-2-4-hashes met sleutel voor tekstinvoer of bestandsuploads. Gebruik een 128-bits hex-sleutel om snelle 128-bits niet-cryptografische hashes te berekenen voor workflows met hashtabellen, cache-sleutels en checksums.",
      },
      no: {
        name: "SipHash-128-2-4-hash tekst eller fil",
        description:
          "Generer nøkkelbaserte SipHash-128-2-4-hasher for tekstinndata eller filopplasting. Bruk en 128-biters heksadesimal nøkkel til å beregne raske 128-biters ikke-kryptografiske hasher for hash-tabell-, cache-nøkkel- og sjekksumarbeidsflyter.",
      },
      pl: {
        name: "SipHash-128-2-4: haszowanie tekstu lub pliku",
        description:
          "Generuj hasze z kluczem SipHash-128-2-4 dla tekstu wejściowego lub przesłanego pliku. Użyj 128-bitowego klucza szesnastkowego, aby obliczać szybkie 128-bitowe niekryptograficzne hasze dla tablic haszujących, kluczy pamięci podręcznej i przepływów pracy z sumami kontrolnymi.",
      },
      pt: {
        name: "Gerar Hash SipHash-128-2-4 de Texto ou Arquivo",
        description:
          "Gere hashes com chave SipHash-128-2-4 para entrada de texto ou upload de arquivo. Use uma chave hexadecimal de 128 bits para calcular hashes não criptográficos rápidos de 128 bits para fluxos de trabalho de tabelas de hash, chaves de cache e somas de verificação.",
      },
      ru: {
        name: "Хеш SipHash-128-2-4 для текста или файла",
        description:
          "Создавайте хеши с ключом SipHash-128-2-4 для текстового ввода или загруженного файла. Используйте 128-битный шестнадцатеричный ключ, чтобы вычислять быстрые 128-битные некриптографические хеши для сценариев с хеш-таблицами, ключами кэша и контрольными суммами.",
      },
      sv: {
        name: "SipHash-128-2-4-hasha text eller fil",
        description:
          "Generera nycklade SipHash-128-2-4-hashar för textinmatning eller filuppladdning. Använd en 128-bitars hexnyckel för att beräkna snabba 128-bitars icke-kryptografiska hashar för arbetsflöden med hashtabeller, cachenycklar och kontrollsummor.",
      },
      th: {
        name: "แฮช SipHash-128-2-4 ข้อความหรือไฟล์",
        description:
          "สร้างแฮชแบบมีคีย์ SipHash-128-2-4 สำหรับข้อความที่ป้อนหรือไฟล์ที่อัปโหลด ใช้คีย์เลขฐานสิบหก 128 บิตเพื่อคำนวณแฮช 128 บิตแบบไม่ใช่การเข้ารหัสที่รวดเร็ว สำหรับเวิร์กโฟลว์ตารางแฮช คีย์แคช และเช็คซัม",
      },
      tr: {
        name: "SipHash-128-2-4 Metin veya Dosya Karması",
        description:
          "Metin girişi veya dosya yüklemesi için SipHash-128-2-4 anahtarlı karmaları oluşturun. Karma tablosu, önbellek anahtarı ve sağlama toplamı iş akışları için hızlı 128 bitlik kriptografik olmayan karmaları hesaplamak üzere 128 bitlik bir onaltılık anahtar kullanın.",
      },
      vi: {
        name: "Băm văn bản hoặc tệp bằng SipHash-128-2-4",
        description:
          "Tạo mã băm có khóa SipHash-128-2-4 cho đầu vào văn bản hoặc tệp tải lên. Dùng khóa hex 128 bit để tính nhanh mã băm 128 bit không dùng cho mật mã trong quy trình bảng băm, cache key và checksum.",
      },
      "zh-CN": {
        name: "SipHash-128-2-4 哈希文本或文件",
        description:
          "为文本输入或文件上传生成 SipHash-128-2-4 带密钥哈希。使用 128 位十六进制密钥计算快速的 128 位非密码学哈希，适用于哈希表、缓存键和校验和工作流。",
      },
      "zh-TW": {
        name: "SipHash-128-2-4 文字或檔案雜湊",
        description:
          "為文字輸入或檔案上傳產生 SipHash-128-2-4 金鑰雜湊。使用 128 位元十六進位金鑰，計算快速的 128 位元非密碼學雜湊，用於雜湊表、快取鍵與校驗和工作流程。",
      },
    },
  },
  {
