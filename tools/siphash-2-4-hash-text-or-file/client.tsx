...
type SipHash24HashTextOrFileClientProps = Readonly<{
  messages: SipHash24HashTextOrFilePageMessages
}>

function SipHash24HashTextOrFileClient({
  messages,
}: SipHash24HashTextOrFileClientProps) {
  ...
  useEffect(() => {
    ...
    void hashSipHash24(source, keyState.key)
      .then((digest) => {
        if (!cancelled) {
...
export default SipHash24HashTextOrFileClient
