...
xxHash ialah algoritma hash bukan kriptografi yang sangat pantas yang memberi tumpuan kepada kelajuan dan prestasi sambil mengekalkan sifat pengedaran yang baik. XXH64 ialah varian 64-bit yang menghasilkan nilai hash 64-bit (8-byte), biasanya dipaparkan sebagai nombor heksadesimal 16 aksara.
...
- **Output lebih besar**: Hash 64-bit memberikan rintangan perlanggaran yang lebih baik daripada varian 32-bit
