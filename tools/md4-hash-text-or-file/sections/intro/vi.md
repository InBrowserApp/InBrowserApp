...
MD4 (Message Digest Algorithm 4) là một hàm băm mật mã được sử dụng rộng rãi tạo ra giá trị băm 128-bit (16-byte), thường được hiển thị dưới dạng số thập lục phân 32 ký tự. Nó được thiết kế bởi Ron Rivest năm 1990.
...
**Tình trạng bảo mật:**
⚠️ **MD4 đã bị phá vỡ về mặt mật mã và không nên được sử dụng cho các ứng dụng quan trọng về bảo mật**. Các cuộc tấn công va chạm được chứng minh vào năm 1995, và việc tạo ra va chạm thực tế trở nên khả thi với sức mạnh tính toán hiện đại.
