...
MD4 (Algoritmo de Resumen de Mensaje 4) es una función hash criptográfica ampliamente utilizada que produce un valor hash de 128 bits (16 bytes), típicamente representado como un número hexadecimal de 32 caracteres. Fue diseñado por Ron Rivest en 1990.
...
**Estado de seguridad:**
⚠️ **MD4 está criptográficamente roto y no debe usarse para aplicaciones críticas de seguridad**. Los ataques de colisión se demostraron en 1995, y la generación práctica de colisiones se hizo factible con el poder computacional moderno.
...
- Sistemas heredados que requieren MD4
