...
**Stato di sicurezza:**
⚠️ **MD4 è crittograficamente compromesso e non dovrebbe essere usato per applicazioni critiche per la sicurezza**. Gli attacchi di collisione sono stati dimostrati nel 1995, e la generazione pratica di collisioni è diventata fattibile con la potenza di calcolo moderna.
