## Cos'è MurmurHash3 (x86 128-bit)?

MurmurHash3 è un algoritmo hash non crittografico veloce progettato per
checksum ripetibili e ben distribuiti. La variante x86 128-bit restituisce
un valore di 16 byte, di solito mostrato come 32 caratteri esadecimali, il che
lo rende più adatto degli hash da 32-bit quando vuoi un identificatore più ampio
...
- **Deduplicazione**: Confronta grandi insiemi di testi o file con impronte
  compatte da 128-bit prima di effettuare controlli più approfonditi.
...
Il seme facoltativo è un valore intero senza segno da 32-bit. Usa lo stesso seme
...
stesso intervallo da 32-bit usato dall'algoritmo.
