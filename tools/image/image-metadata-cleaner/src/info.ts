export const toolID = 'image-metadata-cleaner'
export { Image24Regular as icon } from '@shared/icons/fluent'
export const path = '/tools/image-metadata-cleaner'
export const tags = [
  'image',
  'metadata',
  'exif',
...
export const meta = {
  ...
  zh: {
    name: '图片元数据清理器（EXIF）',
    description: '无需重新编码，移除图片中的 EXIF/XMP/IPTC/ICC 等元数据，保留原始格式并离线运行。',
  },
  'zh-CN': {
    name: '图片元数据清理器（EXIF）',
    description: '无需重新编码，移除图片中的 EXIF/XMP/IPTC/ICC 等元数据，保留原始格式并离线运行。',
  ...
  'zh-TW': {
    name: '圖片元資料清理器（EXIF）',
    description: '無需重新編碼，移除圖片中的 EXIF/XMP/IPTC/ICC 等元資料，保留原始格式並離線運行。',
  },
  'zh-HK': {
    name: '圖片元資料清理器（EXIF）',
    description: '無需重新編碼，移除圖片中的 EXIF/XMP/IPTC/ICC 等元資料，保留原始格式並離線運行。',
