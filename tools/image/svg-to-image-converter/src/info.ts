...
export const meta = {
  ...
  zh: { name: 'SVG 转图片转换器', description: '将 SVG 文件转换为 PNG、JPEG 或 WebP 图片' },
  'zh-CN': { name: 'SVG 转图片转换器', description: '将 SVG 文件转换为 PNG、JPEG 或 WebP 图片' },
  'zh-TW': { name: 'SVG 轉圖片轉換器', description: '將 SVG 檔案轉換為 PNG、JPEG 或 WebP 圖片' },
  'zh-HK': { name: 'SVG 轉圖片轉換器', description: '將 SVG 檔案轉換為 PNG、JPEG 或 WebP 圖片' },
  es: {
  ...
  fr: {
    ...
    description: 'Convertissez des fichiers SVG en images PNG, JPEG ou WebP',
  },
  de: {
    name: 'SVG-zu-Bild-Konverter',
    description: 'Konvertieren Sie SVG-Dateien in PNG-, JPEG- oder WebP-Bilder',
  },
  it: {
  ...
  tr: {
    ...
    description: 'SVG dosyalarını PNG, JPEG veya WebP görüntülerine dönüştürün',
  },
  nl: {
    name: 'SVG-naar-afbeelding converter',
    description: 'Converteer SVG-bestanden naar PNG-, JPEG- of WebP-afbeeldingen',
  },
  sv: {
