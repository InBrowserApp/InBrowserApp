<template>
  <ToolDefaultPageLayout :info="toolInfo">
    <GifToAnimatedWebpUploadSection v-model:files="files" />

    <GifToAnimatedWebpOptionsSection
      v-if="files.length"
      v-model:scale="scale"
      v-model:speed="speed"
    ...
    <GifToAnimatedWebpResultsSection
      v-if="results.length"
      :results="results"
      :zip-blob="zipBlob"
...
import GifToAnimatedWebpNote from './components/GifToAnimatedWebpNote.vue'
import GifToAnimatedWebpOptionsSection from './components/GifToAnimatedWebpOptionsSection.vue'
import GifToAnimatedWebpResultsSection from './components/GifToAnimatedWebpResultsSection.vue'
import GifToAnimatedWebpUploadSection from './components/GifToAnimatedWebpUploadSection.vue'
