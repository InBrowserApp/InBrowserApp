...
async function handleBeforeUpload(data: { file: UploadFileInfo; fileList: UploadFileInfo[] }) {
  ...
  try {
    const result = await readBarcodeFromFile(uploadedFile)
    if (result) {
      emit('decoded', result)
    } else {
      emit('error', t('noBarcodeFound'))
    }
  } catch {
...
<i18n lang="json">
{
  "en": {
    ...
    "noBarcodeFound": "No barcode or QR code found in the image",
  ...
  "zh-TW": {
    ...
    "uploadAnother": "上傳另一个",
    "noBarcodeFound": "圖片中未找到條碼或 QR Code",
  ...
  "es": {
    ...
    "noBarcodeFound": "No se encontro ningun codigo de barras o QR en la imagen",
  ...
  "fr": {
    ...
    "noBarcodeFound": "Aucun code-barres ou QR trouve dans l'image",
  ...
  "de": {
    ...
    "noBarcodeFound": "Kein Barcode oder QR-Code im Bild gefunden",
  ...
  "it": {
    ...
    "noBarcodeFound": "Nessun codice a barre o QR trovato nell'immagine",
  ...
  "ja": {
    ...
    "noBarcodeFound": "画像にバーコードまたはQRコードが見つかりません",
  ...
  "ko": {
    ...
    "noBarcodeFound": "이미지에서 바코드 또는 QR 코드를 찾을 수 없습니다",
  ...
  "ru": {
    ...
    "noBarcodeFound": "Штрихкод или QR-код не найден на изображении",
  ...
  "pt": {
    ...
    "noBarcodeFound": "Nenhum codigo de barras ou QR encontrado na imagem",
    "failedToReadImage": "Falha ao ler a imagem"
  },
  "ar": {
    "dragDropOrClick": "انقر أو اسحب الصورة للتحميل",
    "supportedFormats": "يدعم PNG وJPG وWebP وGIF وBMP وSVG وملفات صور أخرى",
    "uploadAnother": "تحميل آخر",
    "noBarcodeFound": "لم يتم العثور على باركود أو QR في الصورة",
  ...
  "hi": {
    ...
    "noBarcodeFound": "छवि में बारकोड या QR कोड नहीं मिला",
  ...
  "tr": {
    ...
    "noBarcodeFound": "Gorselde barkod veya QR kodu bulunamadi",
  ...
  "nl": {
    ...
    "noBarcodeFound": "Geen barcode of QR-code gevonden in de afbeelding",
  ...
  "sv": {
    ...
    "noBarcodeFound": "Ingen streckkod eller QR-kod hittades i bilden",
  ...
  "pl": {
    ...
    "noBarcodeFound": "Nie znaleziono kodu kreskowego lub QR na obrazie",
  ...
  "vi": {
    ...
    "noBarcodeFound": "Khong tim thay ma vach hoac QR trong anh",
  ...
  "th": {
    ...
    "noBarcodeFound": "ไม่พบบาร์โค้ดหรือ QR Code ในรูปภาพ",
  ...
  "id": {
    ...
    "noBarcodeFound": "Tidak ada kode batang atau QR ditemukan di gambar",
  ...
  "he": {
    ...
    "noBarcodeFound": "לא נמצא ברקוד או קוד QR בתמונה",
  ...
  "ms": {
    ...
    "noBarcodeFound": "Tiada kod bar atau QR ditemui dalam imej",
  ...
  "no": {
    ...
    "noBarcodeFound": "Ingen strekkode eller QR-kode funnet i bildet",
