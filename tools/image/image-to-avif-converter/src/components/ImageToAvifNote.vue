...
{
  "en": {
    "note": "Runs locally in your browser with AVIF encoding in a worker. Animated inputs export the first frame only. No uploads."
  },
  "zh": {
    "note": "所有操作均在本地浏览器完成，AVIF 编码在 worker 中执行。动画图片只会导出首帧，不会上传文件。"
  },
  "zh-CN": {
    "note": "所有操作均在本地浏览器完成，AVIF 编码在 worker 中执行。动画图片只会导出首帧，不会上传文件。"
  },
  "zh-TW": {
    "note": "所有操作都在本機瀏覽器完成，AVIF 編碼會在 worker 中執行。動畫圖片只會匯出首幀，不會上傳檔案。"
  },
  "zh-HK": {
    "note": "所有操作都在本機瀏覽器完成，AVIF 編碼會在 worker 中執行。動畫圖片只會匯出首幀，不會上傳檔案。"
  },
