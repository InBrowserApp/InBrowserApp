...
<i18n lang="json">
{
  "en": {
    ...
    "supportedFormats": "Supports PNG, JPG, AVIF, GIF, SVG",
  ...
  "zh": {
    ...
    "supportedFormats": "支持 PNG、JPG、AVIF、GIF、SVG",
  ...
  "zh-TW": {
    ...
    "supportedFormats": "支援 PNG、JPG、AVIF、GIF、SVG",
  ...
  "es": {
    ...
    "supportedFormats": "Admite PNG, JPG, AVIF, GIF, SVG",
  ...
  "fr": {
    ...
    "supportedFormats": "Prend en charge PNG, JPG, AVIF, GIF, SVG",
  ...
  "de": {
    ...
    "supportedFormats": "Unterstützt PNG, JPG, AVIF, GIF, SVG",
  ...
  "it": {
    ...
    "supportedFormats": "Supporta PNG, JPG, AVIF, GIF, SVG",
  ...
  "ja": {
    ...
    "supportedFormats": "PNG、JPG、AVIF、GIF、SVG に対応",
  ...
  "ko": {
    ...
    "supportedFormats": "PNG, JPG, AVIF, GIF, SVG 지원",
  ...
  "ru": {
    ...
    "supportedFormats": "Поддерживает PNG, JPG, AVIF, GIF, SVG",
  ...
  "pt": {
    ...
    "supportedFormats": "Suporta PNG, JPG, AVIF, GIF, SVG",
  ...
  "ar": {
    ...
    "supportedFormats": "يدعم PNG وJPG وAVIF وGIF وSVG",
  ...
  "hi": {
    ...
    "supportedFormats": "PNG, JPG, AVIF, GIF, SVG समर्थित",
  ...
  "tr": {
    ...
    "supportedFormats": "PNG, JPG, AVIF, GIF, SVG desteklenir",
  ...
  "nl": {
    ...
    "supportedFormats": "Ondersteunt PNG, JPG, AVIF, GIF, SVG",
  ...
  "sv": {
    ...
    "supportedFormats": "Stöder PNG, JPG, AVIF, GIF, SVG",
  ...
  "pl": {
    ...
    "supportedFormats": "Obsługuje PNG, JPG, AVIF, GIF, SVG",
  ...
  "vi": {
    ...
    "supportedFormats": "Hỗ trợ PNG, JPG, AVIF, GIF, SVG",
  ...
  "th": {
    ...
    "supportedFormats": "รองรับ PNG, JPG, AVIF, GIF, SVG",
  ...
  "id": {
    ...
    "supportedFormats": "Mendukung PNG, JPG, AVIF, GIF, SVG",
  ...
  "he": {
    ...
    "supportedFormats": "תומך ב-PNG, JPG, AVIF, GIF, SVG",
  ...
  "ms": {
    ...
    "supportedFormats": "Menyokong PNG, JPG, AVIF, GIF, SVG",
  ...
  "no": {
    ...
    "supportedFormats": "Støtter PNG, JPG, AVIF, GIF, SVG",
