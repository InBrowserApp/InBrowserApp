...
function HighlightedYaml({
  ...
  if (state === "empty") {
    return (
      ...
      >
        <div className="yaml-highlight-empty flex min-h-80 items-center">
  ...
  if (state === "error") {
    return (
      <div
        ...
        aria-label={ariaLabel}
        className={cn(
          "yaml-highlight-surface flex min-h-80 w-full flex-1 items-stretch rounded-lg border bg-transparent px-2.5 py-2",
          "border-destructive/50"
        )}
      >
        <div
          role="alert"
          className="yaml-highlight-error flex min-h-80 items-start gap-3"
        >
