...
describe('chinese-uppercase-number-converter exports', () => {
  it('exposes tool metadata and routes', () => {
    expect(toolInfo.toolID).toBe('chinese-uppercase-number-converter')
    expect(toolInfo.path).toBe('/tools/chinese-uppercase-number-converter')
