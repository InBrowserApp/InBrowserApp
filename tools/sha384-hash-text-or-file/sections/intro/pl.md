...
SHA-384 (Secure Hash Algorithm 384-bit) to kryptograficzna funkcja skrótu, która produkuje 384-bitową (48-bajtową) wartość skrótu, zazwyczaj przedstawianą jako 96-znakową liczbę szesnastkową. Jest częścią rodziny funkcji skrótu SHA-2 zaprojektowanych przez NSA i opublikowanych przez NIST.
...
- Blockchain i kryptowaluty (niektóre systemy używają SHA-384)
