...
SHA-384 (Secure Hash Algorithm 384-bit) is een cryptografische hashfunctie die een 384-bit (48-byte) hashwaarde produceert, doorgaans weergegeven als een 96-karakter hexadecimaal getal. Het is onderdeel van de SHA-2 familie van hashfuncties ontworpen door de NSA en gepubliceerd door NIST.
...
- Blockchain en cryptocurrency (sommige systemen gebruiken SHA-384)
