...
SHA-384 (Secure Hash Algorithm 384-bit) er en kryptografisk hash-funksjon som produserer en 384-bits (48-byte) hash-verdi, vanligvis gjengitt som et 96-tegn heksadesimalt tall. Det er en del av SHA-2-familien av hash-funksjoner designet av NSA og publisert av NIST.
...
- Blokkjede og kryptovalutaer (noen systemer bruker SHA-384)
