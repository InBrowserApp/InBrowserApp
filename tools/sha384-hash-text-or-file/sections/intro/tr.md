...
SHA-384 (Güvenli Hash Algoritması 384-bit), tipik olarak 96 karakterlik onaltılık sayı olarak gösterilen 384-bit (48-bayt) hash değeri üreten kriptografik bir hash fonksiyonudur. NSA tarafından tasarlanan ve NIST tarafından yayınlanan SHA-2 hash fonksiyon ailesinin bir parçasıdır.
...
- Blok zinciri ve kripto para birimleri (bazı sistemler SHA-384 kullanır)
