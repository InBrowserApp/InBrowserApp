...
SHA-384 (Secure Hash Algorithm 384-bit) é uma função hash criptográfica que produz um valor hash de 384 bits (48 bytes), tipicamente renderizado como um número hexadecimal de 96 caracteres. Faz parte da família de funções hash SHA-2 projetadas pela NSA e publicadas pelo NIST.
...
- Blockchain e criptomoedas (alguns sistemas usam SHA-384)
