...
SHA-384 (Algorithme de Hachage Sécurisé 384-bit) est une fonction de hachage cryptographique qui produit une valeur de hachage de 384 bits (48 octets), généralement rendue sous forme d'un nombre hexadécimal de 96 caractères. Il fait partie de la famille des fonctions de hachage SHA-2 conçues par la NSA et publiées par le NIST.
...
- Blockchain et cryptomonnaies (certains systèmes utilisent SHA-384)
