...
SHA-384 (Secure Hash Algorithm 384-bit) è una funzione hash crittografica che produce un valore hash di 384 bit (48 byte), tipicamente rappresentato come un numero esadecimale di 96 caratteri. Fa parte della famiglia di funzioni hash SHA-2 progettate dalla NSA e pubblicate dal NIST.
...
- Blockchain e criptovalute (alcuni sistemi usano SHA-384)
