...
SHA-384 (Algoritmo de Hash Seguro de 384 bits) es una función hash criptográfica que produce un valor hash de 384 bits (48 bytes), típicamente representado como un número hexadecimal de 96 caracteres. Es parte de la familia de funciones hash SHA-2 diseñadas por la NSA y publicadas por el NIST.
...
- Blockchain y criptomonedas (algunos sistemas usan SHA-384)
