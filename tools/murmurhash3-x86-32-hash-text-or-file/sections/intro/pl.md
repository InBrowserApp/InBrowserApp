## Czym jest MurmurHash3 (x86 32-bit)?

MurmurHash3 to niezwykle szybki nie-kryptograficzny algorytm skrótu, który skupia się na szybkości i wydajności, zachowując jednocześnie dobre właściwości dystrybucji. MurmurHash3 x86 32-bit to 32-bitowa wersja, która produkuje 32-bitową (4-bajtową) wartość skrótu, zazwyczaj wyświetlaną jako 8-znakowa liczba szesnastkowa.
