## Apa itu SHA3-256 (FIPS 202)?

SHA3-256 (FIPS 202) (Secure Hash Algorithm 256-bit) adalah fungsi hash kriptografi yang menghasilkan nilai hash 256-bit (32-byte), biasanya ditampilkan sebagai angka heksadesimal 64 karakter. Ini adalah bagian dari keluarga fungsi hash SHA-3 yang distandarkan oleh NIST (FIPS 202).
...
- Blockchain dan cryptocurrency (beberapa sistem menggunakan SHA3-256 (FIPS 202))
