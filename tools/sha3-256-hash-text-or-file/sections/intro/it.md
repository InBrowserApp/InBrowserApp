## Cos'è SHA3-256 (FIPS 202)?

SHA3-256 (FIPS 202) (Secure Hash Algorithm 256-bit) è una funzione hash crittografica che produce un valore hash di 256 bit (32 byte), tipicamente rappresentato come un numero esadecimale di 64 caratteri. Fa parte della famiglia di funzioni hash SHA-3 standardizzate dal NIST (FIPS 202).
...
- Blockchain e criptovalute (alcuni sistemi usano SHA3-256 (FIPS 202))
