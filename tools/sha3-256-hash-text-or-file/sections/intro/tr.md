## SHA3-256 (FIPS 202) nedir?

SHA3-256 (FIPS 202) (Güvenli Hash Algoritması 256-bit), tipik olarak 64 karakterlik onaltılık sayı olarak gösterilen 256-bit (32-bayt) hash değeri üreten kriptografik bir hash fonksiyonudur. NIST (FIPS 202) tarafından standartlaştırılan SHA-3 hash fonksiyonu ailesinin bir parçasıdır.
...
- Blok zinciri ve kripto para birimleri (bazı sistemler SHA3-256 (FIPS 202) kullanır)
