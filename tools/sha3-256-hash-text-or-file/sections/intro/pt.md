## O que é SHA3-256 (FIPS 202)?

SHA3-256 (FIPS 202) (Secure Hash Algorithm 256-bit) é uma função hash criptográfica que produz um valor hash de 256 bits (32 bytes), tipicamente renderizado como um número hexadecimal de 64 caracteres. Faz parte da família de funções hash SHA-3 padronizadas pelo NIST (FIPS 202).
...
- Blockchain e criptomoedas (alguns sistemas usam SHA3-256 (FIPS 202))
