## Wat is SHA3-256 (FIPS 202)?

SHA3-256 (FIPS 202) (Secure Hash Algorithm 256-bit) is een cryptografische hashfunctie die een 256-bit (32-byte) hashwaarde produceert, doorgaans weergegeven als een 64-karakter hexadecimaal getal. Het is onderdeel van de SHA-3-familie van hashfuncties die door NIST (FIPS 202) is gestandaardiseerd.
...
- Blockchain en cryptocurrency (sommige systemen gebruiken SHA3-256 (FIPS 202))
