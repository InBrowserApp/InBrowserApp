## ¿Qué es SHA3-256 (FIPS 202)?

SHA3-256 (FIPS 202) (Algoritmo de Hash Seguro de 256 bits) es una función hash criptográfica que produce un valor hash de 256 bits (32 bytes), típicamente representado como un número hexadecimal de 64 caracteres. Es parte de la familia de funciones hash SHA-3 estandarizadas por el NIST (FIPS 202).
...
- Blockchain y criptomonedas (algunos sistemas usan SHA3-256 (FIPS 202))
