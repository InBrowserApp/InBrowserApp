## Vad är SHA3-256 (FIPS 202)?

SHA3-256 (FIPS 202) (Secure Hash Algorithm 256-bit) är en kryptografisk hashfunktion som producerar ett 256-bitars (32-byte) hashvärde, vanligtvis återgivet som ett 64-tecken hexadecimalt tal. Det är en del av SHA-3-familjen av hashfunktioner som standardiserats av NIST (FIPS 202).
...
- Blockkedja och kryptovalutor (Bitcoin använder SHA3-256 (FIPS 202))
