...
import type { Adler32HashTextOrFilePageMessages } from "./client/types"
import { HashOutputGrid } from "./components/hash-output-grid"
import { hashAdler32, type Adler32Digest } from "./core/adler32"

type Adler32DigestState =
  | { status: "idle" }
  | { status: "loading" }
  | { status: "ready"; digest: Adler32Digest }
  | { status: "error"; message: string }

type Adler32HashTextOrFileClientProps = Readonly<{
  messages: Adler32HashTextOrFilePageMessages
}>

function Adler32HashTextOrFileClient({
  messages,
}: Adler32HashTextOrFileClientProps) {
...
export default Adler32HashTextOrFileClient
