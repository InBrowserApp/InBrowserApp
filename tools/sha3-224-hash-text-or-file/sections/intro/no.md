## Hva er SHA3-224 (FIPS 202)?

SHA3-224 (FIPS 202) (Secure Hash Algorithm 224-bit) er en kryptografisk hash-funksjon som produserer en 224-bits (28-byte) hash-verdi, vanligvis gjengitt som et 56-tegn heksadesimalt tall. Det er en del av SHA-3-familien av hashfunksjoner som er standardisert av NIST (FIPS 202).
...
- Blokkjede og kryptovalutaer (noen systemer bruker SHA3-224 (FIPS 202))
