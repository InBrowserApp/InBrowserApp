## Wat is SHA3-224 (FIPS 202)?

SHA3-224 (FIPS 202) (Secure Hash Algorithm 224-bit) is een cryptografische hashfunctie die een 224-bit (28-byte) hashwaarde produceert, doorgaans weergegeven als een 56-karakter hexadecimaal getal. Het is onderdeel van de SHA-3-familie van hashfuncties die door NIST (FIPS 202) is gestandaardiseerd.
...
- Blockchain en cryptocurrency (sommige systemen gebruiken SHA3-224 (FIPS 202))
