## ¿Qué es SHA3-224 (FIPS 202)?

SHA3-224 (FIPS 202) (Algoritmo de Hash Seguro de 224 bits) es una función hash criptográfica que produce un valor hash de 224 bits (28 bytes), típicamente representado como un número hexadecimal de 56 caracteres. Es parte de la familia de funciones hash SHA-3 estandarizadas por el NIST (FIPS 202).
...
- Blockchain y criptomonedas (algunos sistemas usan SHA3-224 (FIPS 202))
