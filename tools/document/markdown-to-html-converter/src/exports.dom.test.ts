...
describe('markdown-to-html-converter exports', () => {
  it('exposes tool metadata and routes', () => {
    expect(toolInfo.toolID).toBe('markdown-to-html-converter')
    expect(toolInfo.path).toBe('/tools/markdown-to-html-converter')
