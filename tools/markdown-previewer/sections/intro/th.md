...
แก้ไขในแผงต้นฉบับขณะที่ตัวอย่างแบบสดติดตามผลลัพธ์ที่เรนเดอร์ แล้วใช้โครงร่างเพื่อตรวจจังหวะ ระยะห่าง และลำดับชั้นของหัวข้อ นำเข้าไฟล์ `.md` ที่มีอยู่ โหลดเอกสารตัวอย่างเพื่อทดสอบตารางและ fenced code blocks และส่งออก HTML เฉพาะเมื่อโครงร่างกับหัวข้อสุดท้ายดูถูกต้องแล้ว
