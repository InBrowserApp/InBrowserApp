...
async function hashSha256(
  ...
  return formatSha256Digest(digest)
}

function formatSha256Digest(digest: ArrayBuffer): Sha256Digest {
...
export { formatSha256Digest, hashSha256 }
