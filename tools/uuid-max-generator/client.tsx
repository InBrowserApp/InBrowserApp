...
import { getMaxUuidRepresentations } from "./core/max-uuid"

import type { UuidMaxMessages } from "./types"

type UuidMaxGeneratorClientProps = Readonly<{
  messages: UuidMaxMessages
}>
...
const REPRESENTATIONS = getMaxUuidRepresentations()
...
function UuidMaxGeneratorClient({ messages }: UuidMaxGeneratorClientProps) {
  return (
...
export default UuidMaxGeneratorClient
