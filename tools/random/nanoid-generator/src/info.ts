...
export const meta = {
  ...
  zh: {
    name: 'NanoID 生成器',
    description: '在浏览器内生成 URL 安全的 NanoID，支持自定义长度和字符集预设。',
  },
  'zh-CN': {
    name: 'NanoID 生成器',
    description: '在浏览器内生成 URL 安全的 NanoID，支持自定义长度和字符集预设。',
  ...
  'zh-TW': {
    name: 'NanoID 產生器',
    description: '在瀏覽器內產生 URL 安全的 NanoID，支援自訂長度與字元集預設。',
  },
  'zh-HK': {
    name: 'NanoID 產生器',
    description: '在瀏覽器內產生 URL 安全的 NanoID，支援自訂長度與字元集預設。',
  ...
  ar: {
    name: 'مولد NanoID',
    description: 'أنشئ NanoID آمنة لعناوين URL في المتصفح مع طول وحروف أبجدية مسبقة قابلة للتخصيص.',
  },
  hi: {
    name: 'NanoID जनरेटर',
    description: 'ब्राउज़र में URL-सुरक्षित NanoID बनाएँ, कस्टम लंबाई और वर्णमाला प्रीसेट के साथ।',
  },
  tr: {
  ...
  he: {
    name: 'מחולל NanoID',
    description: 'צור NanoID בטוחות ל-URL בדפדפן עם אורך וקבוצות תווים מוגדרות מראש.',
  },
  ms: {
    name: 'Penjana NanoID',
    description: 'Jana NanoID selamat URL dalam pelayar dengan panjang dan pratetap abjad tersuai.',
  },
  no: {
    name: 'NanoID-generator',
    description:
