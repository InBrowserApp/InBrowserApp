...
export const meta = {
  ...
  zh: {
    name: 'KSUID 生成器',
    description: '在浏览器内生成 KSUID（可排序唯一标识），支持自定义时间戳。',
  },
  'zh-CN': {
    name: 'KSUID 生成器',
    description: '在浏览器内生成 KSUID（可排序唯一标识），支持自定义时间戳。',
  ...
  'zh-TW': {
    name: 'KSUID 產生器',
    description: '在瀏覽器內產生 KSUID（可排序的唯一識別），支援自訂時間戳。',
  },
  'zh-HK': {
    name: 'KSUID 產生器',
    description: '在瀏覽器內產生 KSUID（可排序的唯一識別），支援自訂時間戳。',
  ...
  ja: {
    name: 'KSUIDジェネレーター',
    description: 'ブラウザ内でKSUID（並べ替え可能な一意ID）を生成。任意のタイムスタンプに対応。',
  },
  ko: {
    name: 'KSUID 생성기',
    description:
  ...
  ar: {
    name: 'مولد KSUID',
    description: 'أنشئ معرفات فريدة قابلة للفرز (KSUID) في المتصفح مع طابع زمني اختياري.',
  },
  hi: {
    name: 'KSUID जनरेटर',
    description:
  ...
  he: {
    name: 'מחולל KSUID',
    description: 'צור מזהים ייחודיים ניתנים למיון (KSUID) בדפדפן עם חותמת זמן אופציונלית.',
  },
  ms: {
    name: 'Penjana KSUID',
    description: 'Jana pengecam unik boleh diisih (KSUID) dalam pelayar dengan cap masa pilihan.',
  },
  no: {
    name: 'KSUID-generator',
    description:
