...
import type { JsonToTomlConverterMessages } from "./client/types"
import { HighlightedToml } from "./components/highlighted-toml"
import { convertJsonToTomlText } from "./core/convert-json-to-toml"

type JsonToTomlConverterClientProps = Readonly<{
  messages: JsonToTomlConverterMessages
}>

function JsonToTomlConverterClient({
  messages,
}: JsonToTomlConverterClientProps) {
  ...
  const result = convertJsonToTomlText(deferredJsonText)
...
export default JsonToTomlConverterClient
