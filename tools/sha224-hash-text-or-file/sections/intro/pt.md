...
SHA-224 (Secure Hash Algorithm 224-bit) é uma função hash criptográfica que produz um valor hash de 224 bits (28 bytes), tipicamente renderizado como um número hexadecimal de 56 caracteres. Faz parte da família de funções hash SHA-2 projetadas pela NSA e publicadas pelo NIST.
