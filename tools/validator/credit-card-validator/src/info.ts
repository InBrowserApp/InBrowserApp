...
export const meta = {
  en: {
    ...
    description: 'Validate credit card numbers using Luhn algorithm and identify card brand',
  },
  zh: {
    name: '信用卡号验证器',
  ...
  ja: {
    name: 'クレジットカード番号検証',
    description: 'Luhnアルゴリズムでクレジットカード番号を検証し、カードブランドを識別',
  },
  ko: {
    name: '신용카드 번호 검증기',
    description: 'Luhn 알고리즘으로 신용카드 번호를 검증하고 카드 브랜드를 식별',
  },
  ru: {
  ...
  ar: {
    ...
    description: 'التحقق من أرقام بطاقات الائتمان باستخدام خوارزمية Luhn وتحديد العلامة التجارية',
  },
  hi: {
  ...
  nl: {
    ...
    description: 'Valideer creditcardnummers met het Luhn-algoritme en identificeer het kaartmerk',
  },
  sv: {
    name: 'Kreditkortsvalidator',
    description: 'Validera kreditkortsnummer med Luhn-algoritmen och identifiera kortmärket',
  },
  pl: {
    name: 'Walidator Karty Kredytowej',
    description: 'Weryfikuj numery kart kredytowych algorytmem Luhna i identyfikuj markę karty',
  },
  vi: {
    name: 'Trình Xác Thực Thẻ Tín Dụng',
    description: 'Xác thực số thẻ tín dụng bằng thuật toán Luhn và nhận dạng thương hiệu thẻ',
  },
  th: {
  ...
  he: {
    ...
    description: 'אימות מספרי כרטיסי אשראי באמצעות אלגוריתם Luhn וזיהוי מותג הכרטיס',
  },
  ms: {
    name: 'Pengesah Kad Kredit',
    description: 'Sahkan nombor kad kredit menggunakan algoritma Luhn dan kenal pasti jenama kad',
  },
  no: {
    name: 'Kredittkortvalidator',
    description: 'Valider kredittkortnumre med Luhn-algoritmen og identifiser kortmerket',
  },
}
