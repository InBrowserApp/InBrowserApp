...
export const IBAN_COUNTRY_SPECS: Record<string, IBANCountrySpec> = {
  ...
  BL: { length: 27, structure: 'F05F05A11F02', example: 'BL391234512345123456789AB13' },
  ...
  EG: { length: 29, structure: 'F04F04F17', example: 'EG800002000156789012345180002' },
  ...
  GF: { length: 27, structure: 'F05F05A11F02', example: 'GF121234512345123456789AB13' },
  GI: { length: 23, structure: 'U04A15', example: 'GI75NWBK000000007099453' },
  GL: { length: 18, structure: 'F04F09F01', example: 'GL8964710001000206' },
  GP: { length: 27, structure: 'F05F05A11F02', example: 'GP791234512345123456789AB13' },
  ...
  MF: { length: 27, structure: 'F05F05A11F02', example: 'MF551234512345123456789AB13' },
  ...
  MQ: { length: 27, structure: 'F05F05A11F02', example: 'MQ221234512345123456789AB13' },
  ...
  NC: { length: 27, structure: 'F05F05A11F02', example: 'NC551234512345123456789AB13' },
  NL: { length: 18, structure: 'U04F10', example: 'NL91ABNA0417164300' },
  NO: { length: 15, structure: 'F04F06F01', example: 'NO9386011117947' },
  PF: { length: 27, structure: 'F05F05A11F02', example: 'PF281234512345123456789AB13' },
  ...
  PM: { length: 27, structure: 'F05F05A11F02', example: 'PM071234512345123456789AB13' },
  ...
  RE: { length: 27, structure: 'F05F05A11F02', example: 'RE131234512345123456789AB13' },
  ...
  TF: { length: 27, structure: 'F05F05A11F02', example: 'TF891234512345123456789AB13' },
  ...
  WF: { length: 27, structure: 'F05F05A11F02', example: 'WF621234512345123456789AB13' },
  XK: { length: 20, structure: 'F04F10F02', example: 'XK051212012345678906' },
  YT: { length: 27, structure: 'F05F05A11F02', example: 'YT021234512345123456789AB13' },
} as const
...
function getStructureRegex(structure: string): RegExp {
...
export function getExpectedCheckDigits(input: string): string | null {
  const normalized = normalizeIBAN(input)
  if (normalized.length < 4) return null
  if (!BASIC_COUNTRY_REGEX.test(normalized)) return null
  ...
  if (Number.isNaN(remainder)) return null
...
export function validateIBAN(input: string): IBANValidationResult {
  ...
  const countrySpec = countryCode ? IBAN_COUNTRY_SPECS[countryCode] : undefined
  ...
  return {
    ...
    isChecksumValid,
    isValid:
      isCountryValid && isLengthValid && isFormatValid && isStructureValid && isChecksumValid,
  }
}
