...
import YamlToJsonConverterView from './YamlToJsonConverterView.vue'
...
describe('YamlToJsonConverterView', () => {
  it('renders the layout and converter', () => {
    const wrapper = mount(YamlToJsonConverterView, {
      global: {
        stubs: {
          ToolDefaultPageLayout: LayoutStub,
          YamlToJsonConverter: ConverterStub,
        },
      },
    })
