...
export const meta = {
  en: {
    ...
    description: 'Convert YAML to JSON. Paste YAML or import a file; preview, copy, and download.',
  },
  zh: {
    name: 'YAML 转 JSON 转换器',
    description: '将 YAML 转为 JSON。粘贴 YAML 或导入文件；预览、复制并下载。',
  },
  'zh-CN': {
    name: 'YAML 转 JSON 转换器',
    description: '将 YAML 转为 JSON。粘贴 YAML 或导入文件；预览、复制并下载。',
  ...
  'zh-TW': {
    ...
    description: '將 YAML 轉為 JSON。貼上 YAML 或匯入檔案；預覽、複製並下載。',
  },
  'zh-HK': {
    name: 'YAML 轉 JSON 轉換器',
    description: '將 YAML 轉為 JSON。貼上 YAML 或匯入檔案；預覽、複製並下載。',
  ...
  ko: {
    name: 'YAML → JSON 변환기',
    description:
      'YAML을 JSON으로 변환합니다. YAML 붙여넣기 또는 파일 가져오기; 미리보기, 복사, 다운로드.',
  },
  ru: {
  ...
  ar: {
    name: 'محول YAML → JSON',
    description: 'حوّل YAML إلى JSON. الصق YAML أو استورد ملفًا؛ معاينة ونسخ وتنزيل.',
  },
  hi: {
  ...
  tr: {
    ...
    description:
      'YAML’i JSON’a dönüştürün. YAML yapıştırın veya dosya içe aktarın; önizleme, kopyalama ve indirme.',
  },
  nl: {
    name: 'YAML → JSON-converter',
    description:
  ...
  vi: {
    ...
    description: 'Chuyển YAML sang JSON. Dán YAML hoặc nhập tệp; xem trước, sao chép và tải xuống.',
  },
  th: {
    name: 'ตัวแปลง YAML → JSON',
    description: 'แปลง YAML เป็น JSON วาง YAML หรือ นำเข้าไฟล์; ดูตัวอย่าง คัดลอก และดาวน์โหลด',
  },
  id: {
  ...
  he: {
    name: 'ממיר YAML → JSON',
    description: 'המרת YAML ל‑JSON. הדביקו YAML או ייבאו קובץ; תצוגה מקדימה, העתקה והורדה.',
  },
  ms: {
