...
export const toolID = 'json-to-yaml-converter'
export const path = '/tools/json-to-yaml-converter'
export const tags = ['code', 'json', 'yaml', 'converter']
export const features = ['offline']
export const meta = {
  en: {
    name: 'JSON → YAML Converter',
    description: 'Convert JSON to YAML. Paste JSON or import a file; preview, copy, and download.',
  },
  zh: {
    name: 'JSON 转 YAML 转换器',
    description: '将 JSON 转为 YAML。粘贴 JSON 或导入文件；预览、复制并下载。',
  },
  'zh-CN': {
    name: 'JSON 转 YAML 转换器',
    description: '将 JSON 转为 YAML。粘贴 JSON 或导入文件；预览、复制并下载。',
  ...
  'zh-TW': {
    ...
    description: '將 JSON 轉為 YAML。貼上 JSON 或匯入檔案；預覽、複製並下載。',
  },
  'zh-HK': {
    name: 'JSON 轉 YAML 轉換器',
    description: '將 JSON 轉為 YAML。貼上 JSON 或匯入檔案；預覽、複製並下載。',
  ...
  ar: {
    name: 'محول JSON → YAML',
    description: 'حوّل JSON إلى YAML. الصق JSON أو استورد ملفًا؛ معاينة ونسخ وتنزيل.',
  },
  hi: {
  ...
  vi: {
    ...
    description: 'Chuyển JSON sang YAML. Dán JSON hoặc nhập tệp; xem trước, sao chép và tải xuống.',
  },
  th: {
    name: 'ตัวแปลง JSON → YAML',
    description: 'แปลง JSON เป็น YAML วาง JSON หรือ นำเข้าไฟล์; ดูตัวอย่าง คัดลอก และดาวน์โหลด',
  },
  id: {
  ...
  he: {
    name: 'ממיר JSON → YAML',
    description: 'המרת JSON ל‑YAML. הדביקו JSON או ייבאו קובץ; תצוגה מקדימה, העתקה והורדה.',
  },
  ms: {
