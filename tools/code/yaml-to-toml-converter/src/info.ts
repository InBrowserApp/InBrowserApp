...
export const toolID = 'yaml-to-toml-converter'
export const path = '/tools/yaml-to-toml-converter'
export const tags = ['code', 'yaml', 'toml', 'converter']
export const features = ['offline']
export const meta = {
  en: {
    name: 'YAML → TOML Converter',
    description: 'Convert YAML to TOML. Paste YAML or import a file; preview, copy, and download.',
  },
  zh: {
    name: 'YAML 转 TOML 转换器',
    description: '将 YAML 转为 TOML。粘贴 YAML 或导入文件；预览、复制并下载。',
  },
  'zh-CN': {
    name: 'YAML 转 TOML 转换器',
    description: '将 YAML 转为 TOML。粘贴 YAML 或导入文件；预览、复制并下载。',
  ...
  'zh-TW': {
    ...
    description: '將 YAML 轉為 TOML。貼上 YAML 或匯入檔案；預覽、複製並下載。',
  },
  'zh-HK': {
    name: 'YAML 轉 TOML 轉換器',
    description: '將 YAML 轉為 TOML。貼上 YAML 或匯入檔案；預覽、複製並下載。',
  ...
  ar: {
    name: 'محول YAML → TOML',
    description: 'حوّل YAML إلى TOML. الصق YAML أو استورد ملفًا؛ معاينة ونسخ وتنزيل.',
  },
  hi: {
  ...
  tr: {
    ...
    description:
      'YAML’i TOML’a dönüştürün. YAML yapıştırın veya dosya içe aktarın; önizleme, kopyalama ve indirme.',
  },
  nl: {
    name: 'YAML → TOML-converter',
    description:
  ...
  vi: {
    ...
    description: 'Chuyển YAML sang TOML. Dán YAML hoặc nhập tệp; xem trước, sao chép và tải xuống.',
  },
  th: {
    name: 'ตัวแปลง YAML → TOML',
    description: 'แปลง YAML เป็น TOML วาง YAML หรือ นำเข้าไฟล์; ดูตัวอย่าง คัดลอก และดาวน์โหลด',
  },
  id: {
  ...
  he: {
    name: 'ממיר YAML → TOML',
    description: 'המרת YAML ל‑TOML. הדביקו YAML או ייבאו קובץ; תצוגה מקדימה, העתקה והורדה.',
  },
  ms: {
