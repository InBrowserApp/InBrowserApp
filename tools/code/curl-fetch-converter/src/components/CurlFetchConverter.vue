...
<i18n lang="json">
{
  "en": {
    ...
    "fetch-hint": "Supports fetch(url, { method, headers, body }) with literal values.",
    "sample": "Use sample",
    "clear": "Clear",
    "download": "Download",
  ...
  "zh": {
    ...
    "fetch-hint": "支持 fetch(url, { method, headers, body }) 且值为字面量。",
    "sample": "使用示例",
    "clear": "清空",
    "download": "下载",
    "warnings-title": "警告",
  ...
  "zh-TW": {
    ...
    "fetch-hint": "支援 fetch(url, { method, headers, body }) 且值為字面量。",
    "sample": "使用範例",
    "clear": "清除",
    "download": "下載",
    "warnings-title": "警告",
  ...
  "es": {
    ...
    "fetch-hint": "Admite fetch(url, { method, headers, body }) con valores literales.",
    "sample": "Usar ejemplo",
    "clear": "Borrar",
    "download": "Descargar",
  ...
  "fr": {
    ...
    "fetch-hint": "Prend en charge fetch(url, { method, headers, body }) avec des valeurs littérales.",
  ...
  "de": {
    ...
    "fetch-hint": "Unterstützt fetch(url, { method, headers, body }) mit Literalwerten.",
  ...
  "it": {
    ...
    "fetch-hint": "Supporta fetch(url, { method, headers, body }) con valori letterali.",
    "sample": "Usa esempio",
    "clear": "Cancella",
    "download": "Scarica",
  ...
  "ja": {
    ...
    "fetch-hint": "fetch(url, { method, headers, body }) のリテラル値に対応。",
    "sample": "サンプルを使用",
    "clear": "クリア",
    "download": "ダウンロード",
    "warnings-title": "警告",
  ...
  "ko": {
    ...
    "fetch-hint": "리터럴 값의 fetch(url, { method, headers, body })를 지원합니다.",
    "sample": "샘플 사용",
    "clear": "지우기",
    "download": "다운로드",
    "warnings-title": "경고",
  ...
  "ru": {
    ...
    "fetch-hint": "Поддерживает fetch(url, { method, headers, body }) с литеральными значениями.",
  ...
  "pt": {
    ...
    "fetch-hint": "Suporta fetch(url, { method, headers, body }) com valores literais.",
    "sample": "Usar exemplo",
    "clear": "Limpar",
    "download": "Baixar",
  ...
  "ar": {
    ...
    "fetch-hint": "يدعم fetch(url, { method, headers, body }) بقيم حرفية.",
  ...
  "hi": {
    ...
    "fetch-hint": "fetch(url, { method, headers, body }) के literal मान समर्थित हैं।",
  ...
  "tr": {
    ...
    "fetch-hint": "fetch(url, { method, headers, body }) literal değerlerini destekler.",
    "sample": "Örnek kullan",
    "clear": "Temizle",
    "download": "İndir",
  ...
  "nl": {
    ...
    "fetch-hint": "Ondersteunt fetch(url, { method, headers, body }) met letterlijke waarden.",
  ...
  "sv": {
    ...
    "fetch-hint": "Stödjer fetch(url, { method, headers, body }) med litterala värden.",
  ...
  "pl": {
    ...
    "fetch-hint": "Obsługuje fetch(url, { method, headers, body }) z wartościami literałowymi.",
  ...
  "vi": {
    ...
    "fetch-hint": "Hỗ trợ fetch(url, { method, headers, body }) với giá trị literal.",
    "sample": "Dùng ví dụ",
    "clear": "Xóa",
    "download": "Tải xuống",
  ...
  "th": {
    ...
    "fetch-hint": "รองรับ fetch(url, { method, headers, body }) ที่เป็นค่าแบบลิเทอรัล",
    "sample": "ใช้ตัวอย่าง",
    "clear": "ล้าง",
    "download": "ดาวน์โหลด",
  ...
  "id": {
    ...
    "fetch-hint": "Mendukung fetch(url, { method, headers, body }) dengan nilai literal.",
  ...
  "he": {
    ...
    "fetch-hint": "תומך ב‑fetch(url, { method, headers, body }) עם ערכים ליטרליים.",
  ...
  "ms": {
    ...
    "fetch-hint": "Menyokong fetch(url, { method, headers, body }) dengan nilai literal.",
    "sample": "Guna contoh",
    "clear": "Kosongkan",
    "download": "Muat turun",
  ...
  "no": {
    ...
    "fetch-hint": "Støtter fetch(url, { method, headers, body }) med literale verdier.",
