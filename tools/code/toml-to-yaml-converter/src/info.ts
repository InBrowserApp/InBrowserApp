...
export const toolID = 'toml-to-yaml-converter'
export const path = '/tools/toml-to-yaml-converter'
export const tags = ['code', 'toml', 'yaml', 'converter']
export const features = ['offline']
export const meta = {
  en: {
    name: 'TOML → YAML Converter',
    description: 'Convert TOML to YAML. Paste TOML or import a file; preview, copy, and download.',
  },
  zh: {
    name: 'TOML 转 YAML 转换器',
    description: '将 TOML 转为 YAML。粘贴 TOML 或导入文件；预览、复制并下载。',
  },
  'zh-CN': {
    name: 'TOML 转 YAML 转换器',
    description: '将 TOML 转为 YAML。粘贴 TOML 或导入文件；预览、复制并下载。',
  ...
  'zh-TW': {
    ...
    description: '將 TOML 轉為 YAML。貼上 TOML 或匯入檔案；預覽、複製並下載。',
  },
  'zh-HK': {
    name: 'TOML 轉 YAML 轉換器',
    description: '將 TOML 轉為 YAML。貼上 TOML 或匯入檔案；預覽、複製並下載。',
  ...
  ar: {
    name: 'محول TOML → YAML',
    description: 'حوّل TOML إلى YAML. الصق TOML أو استورد ملفًا؛ معاينة ونسخ وتنزيل.',
  },
  hi: {
  ...
  tr: {
    ...
    description:
      'TOML’i YAML’a dönüştürün. TOML yapıştırın veya dosya içe aktarın; önizleme, kopyalama ve indirme.',
  },
  nl: {
    name: 'TOML → YAML-converter',
    description:
  ...
  vi: {
    ...
    description: 'Chuyển TOML sang YAML. Dán TOML hoặc nhập tệp; xem trước, sao chép và tải xuống.',
  },
  th: {
    name: 'ตัวแปลง TOML → YAML',
    description: 'แปลง TOML เป็น YAML วาง TOML หรือ นำเข้าไฟล์; ดูตัวอย่าง คัดลอก และดาวน์โหลด',
  },
  id: {
  ...
  he: {
    name: 'ממיר TOML → YAML',
    description: 'המרת TOML ל‑YAML. הדביקו TOML או ייבאו קובץ; תצוגה מקדימה, העתקה והורדה.',
  },
  ms: {
