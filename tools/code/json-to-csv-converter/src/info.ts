...
export const toolID = 'json-to-csv-converter'
export const path = '/tools/json-to-csv-converter'
export const tags = ['code', 'json', 'csv', 'converter']
...
export const meta = {
  ...
  zh: {
    name: 'JSON 转 CSV 转换器',
    description: '将 JSON 转为 CSV。粘贴 JSON 或导入文件；调整选项、预览、复制并下载。',
  },
  'zh-CN': {
    name: 'JSON 转 CSV 转换器',
    description: '将 JSON 转为 CSV。粘贴 JSON 或导入文件；调整选项、预览、复制并下载。',
  ...
  'zh-TW': {
    name: 'JSON 轉 CSV 轉換器',
    description: '將 JSON 轉為 CSV。貼上 JSON 或匯入檔案；調整選項、預覽、複製並下載。',
  },
  'zh-HK': {
    name: 'JSON 轉 CSV 轉換器',
    description: '將 JSON 轉為 CSV。貼上 JSON 或匯入檔案；調整選項、預覽、複製並下載。',
  ...
  ar: {
    name: 'محول JSON → CSV',
    description: 'حوّل JSON إلى CSV. الصق JSON أو استورد ملفًا؛ اضبط الخيارات، عاين، انسخ ونزّل.',
  },
  hi: {
