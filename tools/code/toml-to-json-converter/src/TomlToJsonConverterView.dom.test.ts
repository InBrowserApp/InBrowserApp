...
import TomlToJsonConverterView from './TomlToJsonConverterView.vue'
...
const ConverterStub = defineComponent({
  name: 'TomlToJsonConverter',
  template: '<div data-testid="converter" />',
})

describe('TomlToJsonConverterView', () => {
  it('renders the layout and converter', () => {
    const wrapper = mount(TomlToJsonConverterView, {
      global: {
        stubs: {
          ToolDefaultPageLayout: LayoutStub,
          TomlToJsonConverter: ConverterStub,
        },
      },
    })
