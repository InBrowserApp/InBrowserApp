...
export const meta = {
  ...
  zh: {
    name: 'XML 转 JSON 转换器',
    description: '将 XML 转为 JSON。粘贴 XML 或导入文件；调整选项、预览、复制并下载。',
  },
  'zh-CN': {
    name: 'XML 转 JSON 转换器',
    description: '将 XML 转为 JSON。粘贴 XML 或导入文件；调整选项、预览、复制并下载。',
  ...
  'zh-TW': {
    name: 'XML 轉 JSON 轉換器',
    description: '將 XML 轉為 JSON。貼上 XML 或匯入檔案；調整選項、預覽、複製並下載。',
  },
  'zh-HK': {
    name: 'XML 轉 JSON 轉換器',
    description: '將 XML 轉為 JSON。貼上 XML 或匯入檔案；調整選項、預覽、複製並下載。',
  ...
  ar: {
    name: 'محول XML → JSON',
    description: 'حوّل XML إلى JSON. الصق XML أو استورد ملفًا؛ اضبط الخيارات، عاين، انسخ ونزّل.',
  },
  hi: {
