...
export const toolID = 'json-to-toml-converter'
export const path = '/tools/json-to-toml-converter'
export const tags = ['code', 'json', 'toml', 'converter']
export const features = ['offline']
export const meta = {
  en: {
    name: 'JSON → TOML Converter',
    description: 'Convert JSON to TOML. Paste JSON or import a file; preview, copy, and download.',
  },
  zh: {
    name: 'JSON 转 TOML 转换器',
    description: '将 JSON 转为 TOML。粘贴 JSON 或导入文件；预览、复制并下载。',
  },
  'zh-CN': {
    name: 'JSON 转 TOML 转换器',
    description: '将 JSON 转为 TOML。粘贴 JSON 或导入文件；预览、复制并下载。',
  ...
  'zh-TW': {
    ...
    description: '將 JSON 轉為 TOML。貼上 JSON 或匯入檔案；預覽、複製並下載。',
  },
  'zh-HK': {
    name: 'JSON 轉 TOML 轉換器',
    description: '將 JSON 轉為 TOML。貼上 JSON 或匯入檔案；預覽、複製並下載。',
  ...
  ar: {
    name: 'محول JSON → TOML',
    description: 'حوّل JSON إلى TOML. الصق JSON أو استورد ملفًا؛ معاينة ونسخ وتنزيل.',
  },
  hi: {
  ...
  vi: {
    ...
    description: 'Chuyển JSON sang TOML. Dán JSON hoặc nhập tệp; xem trước, sao chép và tải xuống.',
  },
  th: {
    name: 'ตัวแปลง JSON → TOML',
    description: 'แปลง JSON เป็น TOML วาง JSON หรือ นำเข้าไฟล์; ดูตัวอย่าง คัดลอก และดาวน์โหลด',
  },
  id: {
  ...
  he: {
    name: 'ממיר JSON → TOML',
    description: 'המרת JSON ל‑TOML. הדביקו JSON או ייבאו קובץ; תצוגה מקדימה, העתקה והורדה.',
  },
  ms: {
