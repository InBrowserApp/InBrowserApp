...
import HtmlEntityEncoderDecoderView from './HtmlEntityEncoderDecoderView.vue'
...
describe('HtmlEntityEncoderDecoderView', () => {
  it('renders the layout and converter', () => {
    const wrapper = mount(HtmlEntityEncoderDecoderView, {
      global: {
        stubs: {
          ToolDefaultPageLayout: LayoutStub,
          HtmlEntityConverter: ConverterStub,
        },
      },
    })
