export const toolID = 'base16-encoder'
export { default as icon } from '@vicons/fluent/TextNumberFormat20Regular'
export const path = '/tools/base16-encoder'
export const tags = [
  'base16',
  'hex',
  'hexadecimal',
...
export const meta = {
  ...
  zh: {
    name: 'Base16 编码器',
    description: '将文本或文件编码为 Base16（Hex），用于数据传输、调试和 Web 开发。',
  },
  'zh-CN': {
    name: 'Base16 编码器',
    description: '将文本或文件编码为 Base16（Hex），用于数据传输、调试和 Web 开发。',
  ...
  'zh-TW': {
    name: 'Base16 編碼器',
    description: '將文字或檔案編碼為 Base16（Hex），用於資料傳輸、除錯和 Web 開發。',
  },
  'zh-HK': {
    name: 'Base16 編碼器',
    description: '將文字或檔案編碼為 Base16（Hex），用於資料傳輸、除錯和 Web 開發。',
  ...
  ko: {
    name: 'Base16 인코더',
    description: '텍스트나 파일을 Base16(Hex)로 인코딩하여 데이터 전송, 디버깅 및 웹 개발에 활용.',
  },
  ru: {
  ...
  he: {
    name: 'מקודד Base16',
    description: 'מקודד טקסט או קבצים ל-Base16 (Hex) להעברת נתונים, ניפוי שגיאות ופיתוח אתרים.',
  },
  ms: {
