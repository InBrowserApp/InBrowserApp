...
defineProps<{
  binary: string
  binaryStatus?: 'success' | 'warning' | 'error'
  octal: string
  octalStatus?: 'success' | 'warning' | 'error'
  decimal: string
  decimalStatus?: 'success' | 'warning' | 'error'
  hex: string
  hexStatus?: 'success' | 'warning' | 'error'
  onInput: (source: 'binary' | 'octal' | 'decimal' | 'hex', value: string) => void
}>()
