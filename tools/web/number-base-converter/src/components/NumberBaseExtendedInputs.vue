...
defineProps<{
  base32: string
  base32Status?: 'success' | 'warning' | 'error'
  base36: string
  base36Status?: 'success' | 'warning' | 'error'
  base62: string
  base62Status?: 'success' | 'warning' | 'error'
  base64: string
  base64Status?: 'success' | 'warning' | 'error'
  onInput: (source: 'base32' | 'base36' | 'base62' | 'base64', value: string) => void
}>()
