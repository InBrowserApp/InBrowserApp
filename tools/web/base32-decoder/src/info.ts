export const toolID = 'base32-decoder'
export { default as icon } from '@vicons/fluent/TextNumberFormat20Regular'
export const path = '/tools/base32-decoder'
export const tags = [
  'base32',
  'decode',
  'decoder',
...
export const meta = {
  ...
  zh: {
    name: 'Base32 解码器',
    description: '将 Base32 文本或文件解码还原为原始数据，用于传输、存储和集成。',
  },
  'zh-CN': {
    name: 'Base32 解码器',
    description: '将 Base32 文本或文件解码还原为原始数据，用于传输、存储和集成。',
  ...
  'zh-TW': {
    name: 'Base32 解碼器',
    description: '將 Base32 文字或檔案解碼還原為原始資料，用於傳輸、儲存和整合。',
  },
  'zh-HK': {
    name: 'Base32 解碼器',
    description: '將 Base32 文字或檔案解碼還原為原始資料，用於傳輸、儲存和整合。',
