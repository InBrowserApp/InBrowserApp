export const toolID = 'base16-decoder'
export { default as icon } from '@vicons/fluent/TextNumberFormat20Regular'
export const path = '/tools/base16-decoder'
export const tags = [
  'base16',
  'hex',
  'hexadecimal',
...
export const meta = {
  ...
  zh: {
    name: 'Base16 解码器',
    description: '将 Base16（Hex）文本或文件解码为原始字节，用于检查、测试和工具处理。',
  },
  'zh-CN': {
    name: 'Base16 解码器',
    description: '将 Base16（Hex）文本或文件解码为原始字节，用于检查、测试和工具处理。',
  ...
  'zh-TW': {
    name: 'Base16 解碼器',
    description: '將 Base16（Hex）文字或檔案解碼為原始位元組，用於檢視、測試和工具處理。',
  },
  'zh-HK': {
    name: 'Base16 解碼器',
    description: '將 Base16（Hex）文字或檔案解碼為原始位元組，用於檢視、測試和工具處理。',
  ...
  ja: {
    name: 'Base16 デコーダー',
    description: 'Base16（Hex）のテキストやファイルを生バイトにデコードし、検査やテストに使用。',
  },
  ko: {
    name: 'Base16 디코더',
    description: 'Base16(Hex) 텍스트나 파일을 원시 바이트로 디코딩하여 검사, 테스트, 도구에 활용.',
  },
  ru: {
    name: 'Base16-декодер',
    description:
  ...
  ar: {
    name: 'مُفكِّك Base16',
    description: 'يفك ترميز نصوص أو ملفات Base16 (Hex) إلى بايتات خام للفحص والاختبار والأدوات.',
  },
  hi: {
    name: 'Base16 डिकोडर',
    description:
  ...
  he: {
    name: 'מפענח Base16',
    description: 'מפענח טקסט או קבצים Base16 (Hex) לבייטים גולמיים לצורך בדיקה, ניסוי וכלים.',
  },
  ms: {
