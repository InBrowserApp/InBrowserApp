export const toolID = 'base32-encoder'
export { default as icon } from '@vicons/fluent/TextNumberFormat20Regular'
export const path = '/tools/base32-encoder'
export const tags = [
  'base32',
  'encode',
  'encoder',
...
export const meta = {
  ...
  zh: {
    name: 'Base32 编码器',
    description: '将文本或文件编码为 Base32，用于数据传输、存储和 Web 开发。',
  },
  'zh-CN': {
    name: 'Base32 编码器',
    description: '将文本或文件编码为 Base32，用于数据传输、存储和 Web 开发。',
  ...
  'zh-TW': {
    name: 'Base32 編碼器',
    description: '將文字或檔案編碼為 Base32，用於資料傳輸、儲存和 Web 開發。',
  },
  'zh-HK': {
    name: 'Base32 編碼器',
    description: '將文字或檔案編碼為 Base32，用於資料傳輸、儲存和 Web 開發。',
  ...
  ar: {
    name: 'مُرمِّز Base32',
    description: 'ترميز النص أو الملفات إلى Base32 لنقل البيانات والتخزين وتطوير الويب.',
  },
  hi: {
    name: 'Base32 एनकोडर',
    description:
  ...
  he: {
    name: 'מקודד Base32',
    description: 'מקודד טקסט או קבצים ל-Base32 להעברת נתונים, אחסון ופיתוח אתרים.',
  },
  ms: {
  ...
  no: {
    name: 'Base32-koder',
    description: 'Kod tekst eller filer til Base32 for dataoverføring, lagring og webutvikling.',
  },
}
