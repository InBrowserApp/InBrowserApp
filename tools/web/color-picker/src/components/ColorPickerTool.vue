...
<i18n lang="json">
{
  "en": {
    ...
    "uploadFormats": "Supports JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "zh": {
    ...
    "uploadFormats": "支持 JPEG、PNG、HEIC、TIFF、WebP、GIF",
    "pickedTitle": "已取颜色",
    "sourceLabel": "来源",
    "sourceScreen": "屏幕",
    "sourceImage": "图片",
  ...
  "zh-TW": {
    ...
    "uploadFormats": "支援 JPEG、PNG、HEIC、TIFF、WebP、GIF",
    "pickedTitle": "已取顏色",
    "sourceLabel": "來源",
    "sourceScreen": "螢幕",
    "sourceImage": "圖片",
  ...
  "es": {
    ...
    "uploadFormats": "Soporta JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "fr": {
    ...
    "uploadFormats": "Prend en charge JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "de": {
    ...
    "uploadFormats": "Unterstützt JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "it": {
    ...
    "uploadFormats": "Supporta JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "ja": {
    ...
    "uploadFormats": "JPEG、PNG、HEIC、TIFF、WebP、GIF をサポート",
    "pickedTitle": "取得した色",
    "sourceLabel": "ソース",
    "sourceScreen": "画面",
    "sourceImage": "画像",
  ...
  "ko": {
    ...
    "uploadFormats": "JPEG, PNG, HEIC, TIFF, WebP, GIF 지원",
    "pickedTitle": "선택된 색상",
    "sourceLabel": "출처",
    "sourceScreen": "화면",
    "sourceImage": "이미지",
  ...
  "ru": {
    ...
    "uploadFormats": "Поддерживает JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "pt": {
    ...
    "uploadFormats": "Suporta JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "ar": {
    ...
    "uploadFormats": "يدعم JPEG، PNG، HEIC، TIFF، WebP، GIF",
  ...
  "hi": {
    ...
    "uploadFormats": "JPEG, PNG, HEIC, TIFF, WebP, GIF समर्थित",
  ...
  "tr": {
    ...
    "uploadFormats": "JPEG, PNG, HEIC, TIFF, WebP, GIF desteklenir",
  ...
  "nl": {
    ...
    "uploadFormats": "Ondersteunt JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "sv": {
    ...
    "uploadFormats": "Stöder JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "pl": {
    ...
    "uploadFormats": "Obsługuje JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "vi": {
    ...
    "uploadFormats": "Hỗ trợ JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "th": {
    ...
    "uploadFormats": "รองรับ JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "id": {
    ...
    "uploadFormats": "Mendukung JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "he": {
    ...
    "uploadFormats": "תומך ב-JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "ms": {
    ...
    "uploadFormats": "Menyokong JPEG, PNG, HEIC, TIFF, WebP, GIF",
  ...
  "no": {
    ...
    "uploadFormats": "Støtter JPEG, PNG, HEIC, TIFF, WebP, GIF",
