## O que é SHA3-512 (FIPS 202)?

SHA3-512 (FIPS 202) (Secure Hash Algorithm 512-bit) é uma função hash criptográfica que produz um valor hash de 512 bits (64 bytes), tipicamente renderizado como um número hexadecimal de 128 caracteres. Faz parte da família de funções hash SHA-3 padronizadas pelo NIST (FIPS 202).
...
- Blockchain e criptomoedas (alguns sistemas usam SHA3-512 (FIPS 202))
