## Was ist SHA3-512 (FIPS 202)?

SHA3-512 (FIPS 202) (Secure Hash Algorithm 512-Bit) ist eine kryptographische Hash-Funktion, die einen 512-Bit (64-Byte) Hash-Wert erzeugt, der typischerweise als 128-stellige Hexadezimalzahl dargestellt wird. Es ist Teil der SHA-3-Familie von Hash-Funktionen, die vom NIST (FIPS 202) standardisiert wurden.
...
- Blockchain und Kryptowährungen (einige Systeme verwenden SHA3-512 (FIPS 202))
