## Apa itu SHA3-512 (FIPS 202)?

SHA3-512 (FIPS 202) (Secure Hash Algorithm 512-bit) adalah fungsi hash kriptografi yang menghasilkan nilai hash 512-bit (64-byte), biasanya ditampilkan sebagai angka heksadesimal 128 karakter. Ini adalah bagian dari keluarga fungsi hash SHA-3 yang distandarkan oleh NIST (FIPS 202).
...
- Blockchain dan cryptocurrency (beberapa sistem menggunakan SHA3-512 (FIPS 202))
