## Qu'est-ce que SHA3-512 (FIPS 202) ?

SHA3-512 (FIPS 202) (Algorithme de Hachage Sécurisé 512-bit) est une fonction de hachage cryptographique qui produit une valeur de hachage de 512 bits (64 octets), généralement rendue sous forme d'un nombre hexadécimal de 128 caractères. Il fait partie de la famille des fonctions de hachage SHA-3 standardisées par le NIST (FIPS 202).
...
- Blockchain et cryptomonnaies (certains systèmes utilisent SHA3-512 (FIPS 202))
