## Hva er SHA3-512 (FIPS 202)?

SHA3-512 (FIPS 202) (Secure Hash Algorithm 512-bit) er en kryptografisk hash-funksjon som produserer en 512-bits (64-byte) hash-verdi, vanligvis gjengitt som et 128-tegn heksadesimalt tall. Det er en del av SHA-3-familien av hashfunksjoner som er standardisert av NIST (FIPS 202).
...
- Blokkjede og kryptovalutaer (noen systemer bruker SHA3-512 (FIPS 202))
