## Czym jest SHA3-512 (FIPS 202)?

SHA3-512 (FIPS 202) (Secure Hash Algorithm 512-bit) to kryptograficzna funkcja skrótu, która produkuje 512-bitową (64-bajtową) wartość skrótu, zazwyczaj przedstawianą jako 128-znakową liczbę szesnastkową. Jest częścią rodziny funkcji skrótu SHA-3 standaryzowanych przez NIST (FIPS 202).
...
- Blockchain i kryptowaluty (niektóre systemy używają SHA3-512 (FIPS 202))
