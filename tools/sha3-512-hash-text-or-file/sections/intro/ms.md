## Apakah SHA3-512 (FIPS 202)?

SHA3-512 (FIPS 202) (Secure Hash Algorithm 512-bit) adalah fungsi hash kriptografi yang menghasilkan nilai hash 512-bit (64-byte), biasanya dipaparkan sebagai nombor heksadesimal 128 aksara. Ia merupakan sebahagian daripada keluarga fungsi hash SHA-3 yang dipiawaikan oleh NIST (FIPS 202).
...
- Blockchain dan mata wang kripto (sesetengah sistem menggunakan SHA3-512 (FIPS 202))
