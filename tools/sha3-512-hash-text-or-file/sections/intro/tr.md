## SHA3-512 (FIPS 202) nedir?

SHA3-512 (FIPS 202) (Güvenli Hash Algoritması 512-bit), tipik olarak 128 karakterlik onaltılık sayı olarak gösterilen 512-bit (64-bayt) hash değeri üreten kriptografik bir hash fonksiyonudur. NIST (FIPS 202) tarafından standartlaştırılan SHA-3 hash fonksiyonu ailesinin bir parçasıdır.
...
- Blok zinciri ve kripto para birimleri (bazı sistemler SHA3-512 (FIPS 202) kullanır)
