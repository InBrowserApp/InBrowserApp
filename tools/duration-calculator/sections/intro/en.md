...
- `P1DT2H3M4.005S` means 1 day, 2 hours, 3 minutes, and 4.005 seconds.

## How this calculator works

- Enter a base time in `YYYY-MM-DD HH:mm:ss.SSS` and choose the time zone you want to evaluate.
- Enter the duration either as ISO 8601 text or with the day, hour, minute, second, and millisecond fields. The tool keeps both inputs in sync and normalizes overflow.
