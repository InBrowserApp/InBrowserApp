...
JSONPath परीक्षक lets you run JSONPath queries against JSON data directly in the browser and inspect both the matched values and the matched paths side by side.
