## Prettier Code Formatter là gì?

Prettier Code Formatter chạy trực tiếp pipeline Prettier standalone chính
...
dạng tự động sẽ tạm dừng và chuyển sang nút `Format now`, cách này dễ dự đoán
