...
const costFactorStatus = computed(() => (props.costFactorValid ? undefined : 'error'))
const blockSizeStatus = computed(() => (props.blockSizeValid ? undefined : 'error'))
...
const parallelismFeedback = computed(() => {
  if (props.parallelismValid) return ''
  return t('range-invalid', { min: props.parallelismMin, max: props.parallelismMax })
})
