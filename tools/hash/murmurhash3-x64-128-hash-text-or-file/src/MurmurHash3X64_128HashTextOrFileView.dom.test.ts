...
let MurmurHash3X64_128HashTextOrFileView: typeof import('./MurmurHash3X64_128HashTextOrFileView.vue').default

beforeAll(async () => {
  MurmurHash3X64_128HashTextOrFileView = (
    await import('./MurmurHash3X64_128HashTextOrFileView.vue')
  ).default
})

describe('MurmurHash3X64_128HashTextOrFileView', () => {
  it('renders the seed input and hash template', () => {
    const wrapper = mount(MurmurHash3X64_128HashTextOrFileView)
  ...
  it('hashes blob content with the default seed', async () => {
    ...
    expect(hex).toBe('533f6046eb7f610eab97467d60eb63b1')
  })
})
