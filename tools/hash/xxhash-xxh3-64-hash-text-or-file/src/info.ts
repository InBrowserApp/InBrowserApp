export const toolID = 'xxhash-xxh3-64-hash-text-or-file'
export { default as icon } from '@vicons/tabler/Hash'
export const path = '/tools/xxhash-xxh3-64-hash-text-or-file'
export const tags = ['hash', 'xxhash', 'xxh3', 'xxh3-64', 'checksum', 'performance', 'file', 'text', 'fast']
