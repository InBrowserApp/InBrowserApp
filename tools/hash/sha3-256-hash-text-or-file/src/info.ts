export const toolID = 'sha3-256-hash-text-or-file'
export { default as icon } from '@vicons/tabler/Hash'
export const path = '/tools/sha3-256-hash-text-or-file'
export const tags = ['hash', 'sha3', 'sha3-256', 'checksum', 'security', 'file', 'text', 'crypto']
