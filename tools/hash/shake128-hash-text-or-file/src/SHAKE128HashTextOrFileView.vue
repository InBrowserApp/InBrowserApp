...
import WhatIsSHAKE128 from './WhatIsSHAKE128.vue'
...
const hashFunction = computed(() => {
  ...
  return async (blob: Blob): Promise<ArrayBuffer> => {
    ...
    const hashBytes = shake128(new Uint8Array(arrayBuffer), { dkLen: outputBytes })
...
<i18n lang="json">
{
  "en": {
    ...
    "output-length-placeholder": "e.g. 256 (bits)",
    "output-length-invalid": "Enter a multiple of 8 between 8 and 65536."
  },
  "zh": {
    "output-length": "输出长度",
    "output-length-placeholder": "例如 256（位）",
