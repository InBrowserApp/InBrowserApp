export const toolID = 'ripemd128-hash-text-or-file'
export { default as icon } from '@vicons/tabler/Hash'
export const path = '/tools/ripemd128-hash-text-or-file'
export const tags = ['hash', 'ripemd128', 'checksum', 'security', 'file', 'text', 'crypto']
