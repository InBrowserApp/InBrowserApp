export const toolID = 'blake3-hash-text-or-file'
export { default as icon } from '@vicons/tabler/Hash'
export const path = '/tools/blake3-hash-text-or-file'
export const tags = ['hash', 'blake3', 'checksum', 'security', 'file', 'text', 'crypto']
