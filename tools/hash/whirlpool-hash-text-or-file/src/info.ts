export const toolID = 'whirlpool-hash-text-or-file'
export { default as icon } from '@vicons/tabler/Hash'
export const path = '/tools/whirlpool-hash-text-or-file'
export const tags = ['hash', 'whirlpool', 'checksum', 'security', 'file', 'text', 'crypto']
