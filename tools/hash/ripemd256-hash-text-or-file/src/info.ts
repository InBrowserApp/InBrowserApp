export const toolID = 'ripemd256-hash-text-or-file'
export { default as icon } from '@vicons/tabler/Hash'
export const path = '/tools/ripemd256-hash-text-or-file'
export const tags = ['hash', 'ripemd256', 'checksum', 'security', 'file', 'text', 'crypto']
