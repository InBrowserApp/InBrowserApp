...
<i18n lang="json">
{
  "en": {
    ...
    "format-hint": "Format: YYYY-MM-DD HH:mm:ss",
    "now": "Now",
    "swap": "Swap",
    "offset": "Offset",
  ...
  "zh": {
    ...
    "date-time": "日期与时间",
    "datetime-placeholder": "YYYY-MM-DD HH:mm:ss",
    "format-hint": "格式：YYYY-MM-DD HH:mm:ss",
    "now": "现在",
    "swap": "交换",
    "offset": "偏移",
  ...
  "es": {
    ...
    "datetime-placeholder": "YYYY-MM-DD HH:mm:ss",
    "format-hint": "Formato: YYYY-MM-DD HH:mm:ss",
    "now": "Ahora",
    "swap": "Intercambiar",
    "offset": "Desfase",
  ...
  "ja": {
    ...
    "date-time": "日付と時刻",
    "datetime-placeholder": "YYYY-MM-DD HH:mm:ss",
    "format-hint": "形式: YYYY-MM-DD HH:mm:ss",
    "now": "現在",
    "swap": "入れ替え",
    "offset": "オフセット",
  ...
  "ko": {
    ...
    "date-time": "날짜 및 시간",
    "datetime-placeholder": "YYYY-MM-DD HH:mm:ss",
    "format-hint": "형식: YYYY-MM-DD HH:mm:ss",
    "now": "지금",
    "swap": "바꾸기",
    "offset": "오프셋",
  ...
  "ru": {
    ...
    "datetime-placeholder": "YYYY-MM-DD HH:mm:ss",
    "format-hint": "Формат: YYYY-MM-DD HH:mm:ss",
    "now": "Сейчас",
    "swap": "Поменять",
    "offset": "Смещение",
  ...
  "ar": {
    ...
    "datetime-placeholder": "YYYY-MM-DD HH:mm:ss",
    "format-hint": "التنسيق: YYYY-MM-DD HH:mm:ss",
    "now": "الآن",
    "swap": "تبديل",
    "offset": "الإزاحة",
  ...
  "hi": {
    ...
    "datetime-placeholder": "YYYY-MM-DD HH:mm:ss",
    "format-hint": "फ़ॉर्मेट: YYYY-MM-DD HH:mm:ss",
    "now": "अभी",
    "swap": "अदला-बदली",
    "offset": "ऑफ़सेट",
  ...
  "tr": {
    ...
    "datetime-placeholder": "YYYY-MM-DD HH:mm:ss",
    "format-hint": "Biçim: YYYY-MM-DD HH:mm:ss",
    "now": "Şimdi",
    "swap": "Değiştir",
    "offset": "Ofset",
  ...
  "nl": {
    ...
    "datetime-placeholder": "YYYY-MM-DD HH:mm:ss",
    "format-hint": "Formaat: YYYY-MM-DD HH:mm:ss",
    "now": "Nu",
    "swap": "Wisselen",
    "offset": "Offset",
  ...
  "vi": {
    ...
    "date-time": "Ngày & giờ",
    "datetime-placeholder": "YYYY-MM-DD HH:mm:ss",
    "format-hint": "Định dạng: YYYY-MM-DD HH:mm:ss",
    "now": "Bây giờ",
    "swap": "Hoán đổi",
    "offset": "Độ lệch",
  ...
  "th": {
    ...
    "datetime-placeholder": "YYYY-MM-DD HH:mm:ss",
    "format-hint": "รูปแบบ: YYYY-MM-DD HH:mm:ss",
    "now": "ตอนนี้",
    "swap": "สลับ",
    "offset": "ออฟเซ็ต",
  ...
  "he": {
    ...
    "datetime-placeholder": "YYYY-MM-DD HH:mm:ss",
    "format-hint": "פורמט: YYYY-MM-DD HH:mm:ss",
    "now": "עכשיו",
    "swap": "החלפה",
    "offset": "היסט",
