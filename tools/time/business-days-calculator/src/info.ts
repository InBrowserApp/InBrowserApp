...
export const meta = {
  ...
  zh: {
    name: '工作日计算器',
    description: '统计日期之间的工作日，并按自定义周末和节假日进行工作日加减。',
  },
  'zh-CN': {
    name: '工作日计算器',
    description: '统计日期之间的工作日，并按自定义周末和节假日进行工作日加减。',
  ...
  'zh-TW': {
    name: '工作日計算器',
    description: '統計日期之間的工作日，並依自訂週末與節假日進行工作日加減。',
  },
  'zh-HK': {
    name: '工作日計算器',
    description: '統計日期之間的工作日，並按自訂週末與節假日進行工作日加減。',
  },
  es: {
  ...
  ja: {
    name: '営業日計算ツール',
    description: '日付間の営業日を数え、カスタム週末と祝日で営業日を加減します。',
  },
  ko: {
    name: '영업일 계산기',
    description:
  ...
  he: {
    ...
    description: 'סופר ימי עבודה בין תאריכים ומוסיף או מחסיר ימי עבודה עם סופי שבוע וחגים מותאמים.',
  },
  ms: {
