...
<i18n lang="json">
{
  "en": {
    ...
    "holidays": "Holidays",
    "holiday-placeholder": "YYYY-MM-DD, one per line",
  ...
  "zh": {
    ...
    "holidays": "节假日",
    "holiday-placeholder": "YYYY-MM-DD，每行一个",
  ...
  "zh-TW": {
    ...
    "holidays": "節假日",
    "holiday-placeholder": "YYYY-MM-DD，每行一個",
  ...
  "es": {
    ...
    "holidays": "Festivos",
    "holiday-placeholder": "YYYY-MM-DD, uno por línea",
  ...
  "fr": {
    ...
    "holiday-placeholder": "YYYY-MM-DD, un par ligne",
  ...
  "de": {
    ...
    "holidays": "Feiertage",
    "holiday-placeholder": "YYYY-MM-DD, eine pro Zeile",
  ...
  "it": {
    ...
    "holidays": "Festività",
    "holiday-placeholder": "YYYY-MM-DD, uno per riga",
  ...
  "ja": {
    ...
    "holidays": "祝日",
    "holiday-placeholder": "YYYY-MM-DD（1行に1件）",
  ...
  "ko": {
    ...
    "holidays": "공휴일",
    "holiday-placeholder": "YYYY-MM-DD, 한 줄에 하나",
  ...
  "ru": {
    ...
    "holidays": "Праздники",
    "holiday-placeholder": "YYYY-MM-DD, по одному в строке",
  ...
  "pt": {
    ...
    "holidays": "Feriados",
    "holiday-placeholder": "YYYY-MM-DD, um por linha",
  ...
  "ar": {
    ...
    "holidays": "العطلات",
    "holiday-placeholder": "YYYY-MM-DD، واحد لكل سطر",
  ...
  "hi": {
    ...
    "holidays": "छुट्टियां",
    "holiday-placeholder": "YYYY-MM-DD, प्रति पंक्ति एक",
  ...
  "tr": {
    ...
    "holidays": "Tatiller",
    "holiday-placeholder": "YYYY-MM-DD, satır başına bir",
  ...
  "nl": {
    ...
    "holidays": "Feestdagen",
    "holiday-placeholder": "YYYY-MM-DD, één per regel",
  ...
  "sv": {
    ...
    "holidays": "Helgdagar",
    "holiday-placeholder": "YYYY-MM-DD, en per rad",
  ...
  "pl": {
    ...
    "holidays": "Święta",
    "holiday-placeholder": "YYYY-MM-DD, po jednym na linię",
  ...
  "vi": {
    ...
    "holidays": "Ngày lễ",
    "holiday-placeholder": "YYYY-MM-DD, mỗi dòng một ngày",
  ...
  "th": {
    ...
    "holidays": "วันหยุด",
    "holiday-placeholder": "YYYY-MM-DD, หนึ่งรายการต่อบรรทัด",
  ...
  "id": {
    ...
    "holidays": "Hari libur",
    "holiday-placeholder": "YYYY-MM-DD, satu per baris",
  ...
  "he": {
    ...
    "holidays": "חגים",
    "holiday-placeholder": "YYYY-MM-DD, אחד בכל שורה",
  ...
  "ms": {
    ...
    "holidays": "Cuti umum",
    "holiday-placeholder": "YYYY-MM-DD, satu setiap baris",
  ...
  "no": {
    ...
    "holidays": "Fridager",
    "holiday-placeholder": "YYYY-MM-DD, én per linje",
