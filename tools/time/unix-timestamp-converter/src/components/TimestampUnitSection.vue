<template>
  <div>
    ...
    <ToolSection v-if="props.showDetected">
      <n-text depth="3">
        {{ t('detected') }}: {{ detectedUnitLabel }} ({{ props.digitCount }} {{ t('digits') }})
      </n-text>
    </ToolSection>
  </div>
</template>
...
import { NRadioGroup, NRadio, NFlex, NText } from 'naive-ui'
