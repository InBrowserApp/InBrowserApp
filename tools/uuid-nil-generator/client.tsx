    ...
    <div className="flex flex-col gap-2 rounded-md border bg-muted/20 p-3">
      <div className="grid gap-2 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center">
        ...
        <ToolCopyButton
          ...
          className="h-auto min-h-7 max-w-full justify-self-start text-start whitespace-normal sm:justify-self-end"
          variant="ghost"
        />
      </div>
      <code
        className="block overflow-x-auto rounded bg-background px-2.5 py-2 text-left font-mono text-sm break-all whitespace-normal [unicode-bidi:isolate] sm:break-normal sm:whitespace-nowrap"
        dir="ltr"
        translate="no"
      >
        {value}
      ...
      <ToolPanelCard>
        ...
        <ToolPanelCardContent className="gap-4">
          <div className="rounded-md border bg-muted/20 p-4">
            ...
            <code
              className="block overflow-x-auto text-left font-mono text-lg font-semibold break-all whitespace-normal [unicode-bidi:isolate] sm:text-2xl sm:break-normal sm:whitespace-nowrap"
              dir="ltr"
              translate="no"
            >
