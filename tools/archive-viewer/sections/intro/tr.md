...
JSON, Markdown, günlükler, kaynak kodu, CSV, XML, YAML ve TOML gibi metin benzeri dosyalar, eşleşen bir dil mevcut olduğunda söz dizimi vurgulamasıyla önizlenebilir. Yaygın görüntü dosyaları görsel olarak önizlenebilir. Diğer ikili dosyalar indirilebilir durumda kalır, ancak araç bunları görüntülemeye çalışmaz.
