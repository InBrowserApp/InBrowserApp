  ...
  if (state === "empty") {
    return (
      <div
        ...
        className="sitemap-xml-highlight-surface flex min-h-80 w-full flex-1 items-stretch rounded-lg border border-input bg-transparent px-2.5 py-2"
      >
        <div className="sitemap-xml-highlight-empty flex min-h-80 items-center">
  ...
  if (state === "error") {
    return (
      <div
        ...
        aria-label={ariaLabel}
        className={cn(
          "sitemap-xml-highlight-surface flex min-h-80 w-full flex-1 items-stretch rounded-lg border bg-transparent px-2.5 py-2",
          "border-destructive/50"
        )}
      >
        <div
          role="alert"
          className="sitemap-xml-highlight-error flex min-h-80 items-start gap-3"
        >
