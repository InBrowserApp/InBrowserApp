...
<i18n lang="json">
{
  "en": {
    ...
    "summary": "{pageCount} pages in the current document, {selectedCount} selected",
    "undo": "Undo",
    "redo": "Redo",
    ...
    "exportError": "Failed to export organized PDF."
  },
  "zh": {
    "title": "整理页面",
    "summary": "当前文档共 {pageCount} 页，已选择 {selectedCount} 页",
    "undo": "撤销",
    "redo": "重做",
    "selectAll": "全选",
    "clearSelection": "清除选择",
  ...
  "zh-TW": {
    "title": "整理頁面",
    "summary": "目前文件共有 {pageCount} 頁，已選取 {selectedCount} 頁",
    "undo": "復原",
    "redo": "重做",
    "selectAll": "全選",
    "clearSelection": "清除選取",
