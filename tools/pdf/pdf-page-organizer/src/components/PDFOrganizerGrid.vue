...
<i18n lang="json">
{
  "en": {
    "title": "Pages",
    "hint": "Drag pages to reorder. Click a thumbnail to preview. Use Shift while selecting to add a range.",
    "empty": "Upload a PDF to start organizing pages.",
    "selectPage": "Select page {page}",
    "dragPage": "Drag page {page}",
    "previewUnavailable": "Preview unavailable",
    "thumbnailAlt": "Page {page}",
    "pageLabel": "Page {page} · source {source}",
    "moveUp": "Move up",
    "moveDown": "Move down",
  ...
  "zh": {
    "title": "页面",
    "hint": "拖拽页面即可重排，点击缩略图可预览，按住 Shift 选择可连续选中范围。",
    "empty": "上传 PDF 后开始整理页面。",
    "selectPage": "选择第 {page} 页",
    "dragPage": "拖拽第 {page} 页",
    "previewUnavailable": "无法预览",
    "thumbnailAlt": "第 {page} 页",
    "pageLabel": "第 {page} 页 · 原始页 {source}",
    "moveUp": "上移",
    "moveDown": "下移",
    "rotateLeft": "向左旋转",
    "rotateRight": "向右旋转",
  ...
  "zh-TW": {
    "title": "頁面",
    "hint": "拖曳頁面即可重排，點擊縮圖可預覽，按住 Shift 選擇可連續選取範圍。",
    "empty": "上傳 PDF 後開始整理頁面。",
    "selectPage": "選擇第 {page} 頁",
    "dragPage": "拖曳第 {page} 頁",
    "previewUnavailable": "無法預覽",
    "thumbnailAlt": "第 {page} 頁",
    "pageLabel": "第 {page} 頁 · 原始頁 {source}",
    "moveUp": "上移",
    "moveDown": "下移",
    "rotateLeft": "向左旋轉",
    "rotateRight": "向右旋轉",
