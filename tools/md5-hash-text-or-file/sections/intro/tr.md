...
MD5 (Message Digest Algorithm 5), tipik olarak 32 karakterlik onaltılık sayı olarak gösterilen 128-bit (16-bayt) hash değeri üreten yaygın olarak kullanılan kriptografik bir hash fonksiyonudur. 1991 yılında Ron Rivest tarafından MD4'ün halefi olarak tasarlanmıştır.
...
**Güvenlik durumu:**
⚠️ **MD5 kriptografik olarak kırılmıştır ve güvenlik açısından kritik uygulamalar için kullanılmamalıdır**. Çarpışma saldırıları 2004 yılında gösterilmiş ve modern hesaplama gücü ile pratik çarpışma üretimi mümkün hale gelmiştir.
