...
- **Key source** — เลือก *Generate new* เพื่อสร้างคู่คีย์ใหม่ หรือ *Import existing* เพื่อวาง PKCS#8 PEM key ที่ไม่ได้เข้ารหัส คีย์แบบเข้ารหัส, `RSA PRIVATE KEY` แบบเก่า และบล็อก `EC PRIVATE KEY` จะไม่ได้รับการยอมรับ แปลงด้วย `openssl pkcs8 -topk8 -nocrypt` ก่อน
