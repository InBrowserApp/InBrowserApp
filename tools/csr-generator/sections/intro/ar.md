...
- **مصدر المفتاح** — اختر _إنشاء مفتاح جديد_ لإنشاء زوج مفاتيح جديد، أو _استيراد مفتاح موجود_ للصق مفتاح خاص غير مشفَّر بصيغة PKCS#8 PEM. لا تُقبل المفاتيح المشفَّرة أو كتل `RSA PRIVATE KEY` و`EC PRIVATE KEY` القديمة؛ حوِّلها أولاً باستخدام `openssl pkcs8 -topk8 -nocrypt`.
