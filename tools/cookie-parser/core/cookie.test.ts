...
import { parseCookieHeader, parseSetCookieHeaders } from "./cookie"
...
describe("parseCookieHeader", () => {
  ...
  it("parses cookies across lines without header prefixes", () => {
...
describe("parseSetCookieHeaders", () => {
  ...
  it("parses multiple set-cookie headers and ignores other lines", () => {
    const result = parseSetCookieHeaders(
  ...
  it("parses set-cookie headers without a prefix", () => {
