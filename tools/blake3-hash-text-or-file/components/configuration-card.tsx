...
import type { Blake3HashTextOrFilePageMessages } from "../client/types"
import {
      ...
      <CardContent className="grid gap-6">
        <Field>
          ...
          <Slider
            ...
            max={BLAKE3_MAX_OUTPUT_LENGTH}
            min={BLAKE3_MIN_OUTPUT_LENGTH}
            step={BLAKE3_OUTPUT_LENGTH_STEP}
            value={[outputLength]}
          ...
          <div className="flex items-center justify-between text-xs text-muted-foreground">
            <span>{BLAKE3_MIN_OUTPUT_LENGTH}</span>
            <span>{BLAKE3_MAX_OUTPUT_LENGTH}</span>
          </div>
        </Field>
