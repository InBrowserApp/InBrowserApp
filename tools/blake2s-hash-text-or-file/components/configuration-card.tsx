...
import type { Blake2sHashTextOrFilePageMessages } from "../client/types"
import {
      ...
      <CardContent className="grid gap-6">
        <Field>
          ...
          <Slider
            ...
            max={BLAKE2S_MAX_OUTPUT_LENGTH}
            min={BLAKE2S_MIN_OUTPUT_LENGTH}
            step={BLAKE2S_OUTPUT_LENGTH_STEP}
            value={[outputLength]}
          ...
          <div className="flex items-center justify-between text-xs text-muted-foreground">
            <span>{BLAKE2S_MIN_OUTPUT_LENGTH}</span>
            <span>{BLAKE2S_MAX_OUTPUT_LENGTH}</span>
          </div>
        </Field>
