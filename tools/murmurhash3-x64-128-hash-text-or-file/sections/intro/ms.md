## Apakah MurmurHash3 (x64 128-bit)?

MurmurHash3 ialah algoritma hash bukan kriptografi yang pantas, direka untuk
checksum yang boleh diulang dan mempunyai taburan yang baik. Varian x64 128-bit
mengembalikan nilai 16 bait, biasanya dipaparkan sebagai 32 aksara
...
- **Jadual hash dan pensyerdan**: Cipta kunci stabil untuk baldi, petak, atau
  jadual carian.
...
pengesahan kalis ubah. Gunakan SHA-256, HMAC, atau alat hashing kata laluan
...
serta taburan stabil lebih penting daripada rintangan terhadap serangan.
