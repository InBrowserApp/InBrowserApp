## O que é MurmurHash3 (x64 128-bit)?

MurmurHash3 é um algoritmo de hash não criptográfico rápido, projetado para
somas de verificação repetíveis e bem distribuídas. A variante x64 de 128 bits
...
- **Tabelas hash e sharding**: Crie chaves estáveis para buckets, partições ou
  tabelas de consulta.
...
- **Chaves de cache**: Produza identificadores determinísticos para artefatos
  de build, dados transformados ou conteúdo gerado.
...
adequada para hashing local, offline e orientado a performance, quando
