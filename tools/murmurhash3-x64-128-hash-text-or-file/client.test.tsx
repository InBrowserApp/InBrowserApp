...
const messages = {
  meta: {
    ...
    description:
      "Generate MurmurHash3 x64 128-bit hash for text input or file upload.",
  },
  inputLabel: "Input",
...
const STORAGE_KEY = "tools:murmurhash3-x64-128-hash-text-or-file:text"
...
function murmurHex(input: string) {
  switch (input) {
    case "I will not buy this record, it is scratched.":
      return "c382657f9a06c49d4a71fdc6d9b0d48f"
    case "test":
      return "ac7d28cc74bde19d9a128231f9bd4d82"
    case "hello from file":
      return "6bbbb1e7de21da57c7b92577faef1baf"
    case "stored value":
      return "701b6ddc60253bf3f81ef5ffd29f1b66"
    default:
...
function seededMurmurHex(input: string, seed: string) {
  if (input === "test" && seed === "1") {
    return "c3812fdf4d18f852c81a9057aa737aec"
  }
