...
import UUIDV5GeneratorView from './UUIDV5GeneratorView.vue'

const TestWrapper = {
  setup() {
    return () => h(NMessageProvider, () => h(UUIDV5GeneratorView))
  },
}

describe('UUIDV5GeneratorView', () => {
