...
export const meta = {
  ...
  zh: {
    name: 'IPv6 转 MAC 转换器',
    description: '将 IPv6 地址转换为 MAC 地址。输入任何 IPv6 地址，立即提取对应的 MAC 地址。',
  },
  'zh-CN': {
    name: 'IPv6 转 MAC 转换器',
    description: '将 IPv6 地址转换为 MAC 地址。输入任何 IPv6 地址，立即提取对应的 MAC 地址。',
  ...
  'zh-TW': {
    name: 'IPv6 轉 MAC 轉換器',
    description: '將 IPv6 位址轉換為 MAC 位址。輸入任何 IPv6 位址，立即提取對應的 MAC 位址。',
  },
  'zh-HK': {
    name: 'IPv6 轉 MAC 轉換器',
    description: '將 IPv6 位址轉換為 MAC 位址。輸入任何 IPv6 位址，立即提取對應的 MAC 位址。',
  ...
  fr: {
    name: 'Convertisseur IPv6 vers MAC',
    description:
