...
export const meta = {
  ...
  es: {
    ...
    description: 'Buscar y explorar códigos de estado HTTP y sus significados',
  },
  fr: {
    name: 'Recherche de Codes de Statut HTTP',
    description: 'Rechercher et parcourir les codes de statut HTTP et leurs significations',
  },
  de: {
    name: 'HTTP-Statuscode-Suche',
    description: 'HTTP-Statuscodes und ihre Bedeutungen suchen und durchsuchen',
  },
  it: {
    name: 'Ricerca Codici di Stato HTTP',
    description: 'Cerca e sfoglia i codici di stato HTTP e i loro significati',
  },
  ja: {
  ...
  pt: {
    ...
    description: 'Pesquisar e navegar por códigos de status HTTP e seus significados',
  },
  ar: {
  ...
  sv: {
    ...
    description: 'Sök och bläddra bland HTTP statuskoder och deras betydelser',
  },
  pl: {
  ...
  vi: {
    ...
    description: 'Tìm kiếm và duyệt các mã trạng thái HTTP và ý nghĩa của chúng',
  },
  th: {
