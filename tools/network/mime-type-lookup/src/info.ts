...
export const meta = {
  ...
  es: {
    ...
    description: 'Buscar y explorar tipos MIME y sus extensiones de archivo',
  },
  fr: {
    name: 'Recherche de Types MIME',
    description: 'Rechercher et parcourir les types MIME et leurs extensions de fichier',
  },
  de: {
    name: 'MIME-Typ-Suche',
    description: 'MIME-Typen und ihre Dateierweiterungen suchen und durchsuchen',
  },
  it: {
  ...
  pt: {
    name: 'Consulta de Tipos MIME',
    description: 'Pesquisar e navegar por tipos MIME e suas extensões de arquivo',
  },
  ar: {
  ...
  pl: {
    ...
    description: 'Wyszukuj i przeglądaj typy MIME i ich rozszerzenia plików',
  },
  vi: {
    name: 'Tra Cứu Loại MIME',
    description: 'Tìm kiếm và duyệt các loại MIME và phần mở rộng tệp của chúng',
  },
  th: {
