## SHAKE128 (FIPS 202) là gì?

SHAKE128 (FIPS 202) là hàm đầu ra mở rộng (XOF) thuộc họ SHA-3. Khác với các hàm băm có độ dài cố định, nó có thể trả về số bit đầu ra tùy ý trong khi vẫn duy trì mức an toàn 128 bit. Thuật toán này được NIST chuẩn hóa trong FIPS 202 và dựa trên cấu trúc bọt biển Keccak.
