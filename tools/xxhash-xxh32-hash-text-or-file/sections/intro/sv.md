...
xxHash är en extremt snabb icke-kryptografisk hash-algoritm som fokuserar på hastighet och prestanda samtidigt som den bibehåller goda distributionsegenskaper. XXH32 är 32-bitarsvarianten som producerar ett 32-bitars (4-byte) hash-värde, vanligtvis visat som ett 8-tecken hexadecimalt nummer.
