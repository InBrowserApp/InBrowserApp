...
xxHash, iyi dağıtım özelliklerini korurken hız ve performansa odaklanan son derece hızlı bir kriptografik olmayan hash algoritmasıdır. XXH32, tipik olarak 8 karakterlik onaltılık sayı olarak görüntülenen 32-bit (4-bayt) hash değeri üreten 32-bit varyantıdır.
