...
xxHash là một thuật toán băm phi mã hóa cực kỳ nhanh tập trung vào tốc độ và hiệu suất trong khi vẫn duy trì các đặc tính phân phối tốt. XXH32 là biến thể 32-bit tạo ra giá trị băm 32-bit (4-byte), thường được hiển thị dưới dạng số thập lục phân 8 ký tự.
