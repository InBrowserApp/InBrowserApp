...
function NumericField({
  ...
  return (
    <Field className="gap-3">
      ...
      <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_5.5rem_auto] sm:items-center">
        <Slider
  ...
  return (
    <div className="grid gap-5">
      <div className="grid gap-1">
        ...
        <p className="text-sm text-muted-foreground">{messages.outputHint}</p>
      </div>
      ...
      <FieldGroup>
        ...
        <Field className="gap-3" data-invalid={invalidColor || undefined}>
          ...
          <div className="flex flex-wrap gap-2">
            {swatches.map((swatch) => {
              const active =
                activeLayer.color.trim().toUpperCase() === swatch.toUpperCase()
        ...
        <Field className="gap-3">
          <FieldLabel htmlFor="alpha-input">{messages.alphaLabel}</FieldLabel>
        ...
        <Field className="gap-3" orientation="horizontal">
          <FieldLabel htmlFor="inset-switch">{messages.insetLabel}</FieldLabel>
          <Switch
