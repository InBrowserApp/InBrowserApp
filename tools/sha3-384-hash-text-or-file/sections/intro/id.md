## Apa itu SHA3-384 (FIPS 202)?

SHA3-384 (FIPS 202) (Secure Hash Algorithm 384-bit) adalah fungsi hash kriptografi yang menghasilkan nilai hash 384-bit (48-byte), biasanya ditampilkan sebagai angka heksadesimal 96 karakter. Ini adalah bagian dari keluarga fungsi hash SHA-3 yang distandarkan oleh NIST (FIPS 202).
...
- Blockchain dan cryptocurrency (beberapa sistem menggunakan SHA3-384 (FIPS 202))
