## Hva er SHA3-384 (FIPS 202)?

SHA3-384 (FIPS 202) (Secure Hash Algorithm 384-bit) er en kryptografisk hash-funksjon som produserer en 384-bits (48-byte) hash-verdi, vanligvis gjengitt som et 96-tegn heksadesimalt tall. Det er en del av SHA-3-familien av hashfunksjoner som er standardisert av NIST (FIPS 202).
...
- Blokkjede og kryptovalutaer (noen systemer bruker SHA3-384 (FIPS 202))
