## Cos'è SHA3-384 (FIPS 202)?

SHA3-384 (FIPS 202) (Secure Hash Algorithm 384-bit) è una funzione hash crittografica che produce un valore hash di 384 bit (48 byte), tipicamente rappresentato come un numero esadecimale di 96 caratteri. Fa parte della famiglia di funzioni hash SHA-3 standardizzate dal NIST (FIPS 202).
...
- Blockchain e criptovalute (alcuni sistemi usano SHA3-384 (FIPS 202))
