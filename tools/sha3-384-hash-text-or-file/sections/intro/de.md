## Was ist SHA3-384 (FIPS 202)?

SHA3-384 (FIPS 202) (Secure Hash Algorithm 384-Bit) ist eine kryptographische Hash-Funktion, die einen 384-Bit (48-Byte) Hash-Wert erzeugt, der typischerweise als 96-stellige Hexadezimalzahl dargestellt wird. Es ist Teil der SHA-3-Familie von Hash-Funktionen, die vom NIST (FIPS 202) standardisiert wurden.
...
- Blockchain und Kryptowährungen (einige Systeme verwenden SHA3-384 (FIPS 202))
