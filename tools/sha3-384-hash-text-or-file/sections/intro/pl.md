## Czym jest SHA3-384 (FIPS 202)?

SHA3-384 (FIPS 202) (Secure Hash Algorithm 384-bit) to kryptograficzna funkcja skrótu, która produkuje 384-bitową (48-bajtową) wartość skrótu, zazwyczaj przedstawianą jako 96-znakową liczbę szesnastkową. Jest częścią rodziny funkcji skrótu SHA-3 standaryzowanych przez NIST (FIPS 202).
...
- Blockchain i kryptowaluty (niektóre systemy używają SHA3-384 (FIPS 202))
