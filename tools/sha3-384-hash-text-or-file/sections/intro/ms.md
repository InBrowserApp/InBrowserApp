## Apakah SHA3-384 (FIPS 202)?

SHA3-384 (FIPS 202) (Secure Hash Algorithm 384-bit) adalah fungsi hash kriptografi yang menghasilkan nilai hash 384-bit (48-byte), biasanya dipaparkan sebagai nombor heksadesimal 96 aksara. Ia merupakan sebahagian daripada keluarga fungsi hash SHA-3 yang dipiawaikan oleh NIST (FIPS 202).
...
- Blockchain dan mata wang kripto (sesetengah sistem menggunakan SHA3-384 (FIPS 202))
