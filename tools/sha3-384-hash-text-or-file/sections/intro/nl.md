## Wat is SHA3-384 (FIPS 202)?

SHA3-384 (FIPS 202) (Secure Hash Algorithm 384-bit) is een cryptografische hashfunctie die een 384-bit (48-byte) hashwaarde produceert, doorgaans weergegeven als een 96-karakter hexadecimaal getal. Het is onderdeel van de SHA-3-familie van hashfuncties die door NIST (FIPS 202) is gestandaardiseerd.
...
- Blockchain en cryptocurrency (sommige systemen gebruiken SHA3-384 (FIPS 202))
