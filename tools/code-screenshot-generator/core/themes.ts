...
type Theme = Readonly<{
  ...
  lineNumber: string
  accent: string
  tokenStyles: Readonly<Record<string, TokenStyle>>
}>

type BackgroundPreset = Readonly<{
  id: string
  labelKey: string
  type: "linear" | "radial"
  angle?: number
...
const backgroundPresets = [
  ...
  {
    id: "sunset",
    labelKey: "backgroundPresetSunset",
    type: "linear",
    angle: 125,
  ...
  {
    id: "ocean",
    labelKey: "backgroundPresetOcean",
    type: "linear",
    angle: 140,
  ...
  {
    id: "ember",
    labelKey: "backgroundPresetEmber",
    type: "linear",
    angle: 120,
...
const getThemeById = (id: string): Theme =>
  themes.find((theme) => theme.id === id) ?? themes[0]

const getBackgroundPreset = (id: string): BackgroundPreset =>
...
export type { BackgroundPreset, Theme, TokenStyle }
