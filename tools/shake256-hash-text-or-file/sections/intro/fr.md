## Qu’est-ce que SHAKE256 (FIPS 202) ?

SHAKE256 (FIPS 202) est une fonction à sortie extensible (XOF) de la famille SHA-3. Contrairement aux fonctions de hachage à longueur fixe, elle peut renvoyer n’importe quel nombre de bits tout en offrant une sécurité de 256 bits. Elle est normalisée par le NIST dans FIPS 202 et repose sur la construction en éponge Keccak.
