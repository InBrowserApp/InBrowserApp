## Vad är SHAKE256 (FIPS 202)?

SHAKE256 (FIPS 202) är en funktion med utökbar utdatalängd (XOF) i SHA-3-familjen. Till skillnad från hashfunktioner med fast längd kan den returnera valfritt antal utdata-bitar och ändå ge 256-bitars säkerhetsstyrka. Den är standardiserad av NIST i FIPS 202 och bygger på Keccak-svampkonstruktionen.
