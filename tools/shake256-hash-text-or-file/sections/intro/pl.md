## Czym jest SHAKE256 (FIPS 202)?

SHAKE256 (FIPS 202) to funkcja o rozszerzalnej długości wyjścia (XOF) z rodziny SHA-3. W przeciwieństwie do funkcji skrótu o stałej długości może zwracać dowolną liczbę bitów wyjściowych, zachowując 256-bitowy poziom bezpieczeństwa. Jest standaryzowana przez NIST w FIPS 202 i oparta na konstrukcji gąbki Keccak.
