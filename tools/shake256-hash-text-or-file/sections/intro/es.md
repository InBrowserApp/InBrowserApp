## ¿Qué es SHAKE256 (FIPS 202)?

SHAKE256 (FIPS 202) es una función de salida extensible (XOF) de la familia SHA-3. A diferencia de las funciones hash de longitud fija, puede devolver cualquier cantidad de bits de salida y mantener una seguridad de 256 bits. Está estandarizada por NIST en FIPS 202 y se basa en la construcción de esponja de Keccak.
