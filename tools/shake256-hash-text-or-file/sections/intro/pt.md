## O que é SHAKE256 (FIPS 202)?

SHAKE256 (FIPS 202) é uma função de saída extensível (XOF) da família SHA-3. Ao contrário das funções hash de comprimento fixo, ela pode retornar qualquer quantidade de bits de saída mantendo uma força de segurança de 256 bits. É padronizada pelo NIST no FIPS 202 e baseada na construção de esponja do Keccak.
