...
function rgbaToHex(rgba: RGBA, includeAlpha: boolean): string {
...
function formatRgb(rgba: RGBA, includeAlpha: boolean): string {
  const r = clampChannel(rgba.r)
  const g = clampChannel(rgba.g)
  const b = clampChannel(rgba.b)
...
function formatHsl(rgba: RGBA, includeAlpha: boolean): string {
  const r = clampChannel(rgba.r)
  const g = clampChannel(rgba.g)
  const b = clampChannel(rgba.b)
...
function formatHsv(rgba: RGBA, includeAlpha: boolean): string {
  const r = clampChannel(rgba.r)
  const g = clampChannel(rgba.g)
  const b = clampChannel(rgba.b)
...
function formatCmyk(rgba: RGBA): string {
  const r = clampChannel(rgba.r)
  const g = clampChannel(rgba.g)
  const b = clampChannel(rgba.b)
