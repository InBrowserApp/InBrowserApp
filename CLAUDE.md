...
- When translating either site copy or tool copy into all supported languages, fan out via the Agent tool (one sub-agent per language, run in parallel) rather than translating sequentially in the main conversation.
